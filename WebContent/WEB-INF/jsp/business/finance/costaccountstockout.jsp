...
<script type="text/javascript">
	...
	function ajaxFn() {
		...
		var YSId= '${YSId}';
		var actionUrl = "${ctx}/business/stockout?methodtype=getStockoutAndRequiztionDetailById";
		...
		var t = $('#example').DataTable({
			...
			"columns" : [
				...
				}, {"data": "stockOutId","className":"td-left"//1
				}, {"data": "materialId","className":"td-left"//1
				}, {"data": "materialName",						//2
				}, {"data": "checkOutDate","className":"td-center"//1
				}, {"data": "stockoutQty","className":"td-right"//4
				}, {"data": "excessType","className":"td-right"//5
				}, {"data": "remarks"		//7
				}
...
<div id="main">
	...
	<form:form modelAttribute="formModel" method="POST"
		...
		<table class="" id="table_form"  style="margin-top: -10px;width: 100%;">
			<tr> 				
				<td class="td-center" colspan="6" style="font-size: 26px;height: 50px;">领料单明细</td>
			</tr>
		</table>
			...
			<table id="example" class="display" width="100%">
				<thead>				
					<tr>
						...
						<th >物料名称</th>
						<th width="70px">出库时间</th>
						<th width="70px">出库数量</th>
						<th width="60px">出库类别</th>
