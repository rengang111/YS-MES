	...
	function ajax(colNum,type,scrollHeight,sessionFlag) {
		...
		var t = $('#TMaterial').DataTable({
				...
				"columns": [
					...
					{"data": "agreementDate", "className" : 'td-center'},//8约定付款日
					{"data": "finishDate", "className" : 'td-center'},//9实际付款日
				...
				<table style="width: 100%;" id="TMaterial" class="display">
					<thead>						
						<tr>					
							...
							<th width="65px">耀升编号</th>							
							<th width="70px">供应商编号</th>						
							<th>供应商名称</th>
							<th width="60px">合同金额</th>
							<th width="60px">应付款</th>
							<th width="65px">约定付款日</th>
							<th width="65px">实际付款日</th>
