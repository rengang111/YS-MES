...
<script type="text/javascript">
	...
	function ajax(action,type,scrollHeight,sessionFlag,SearchFlag) {
		...
		var url = "${ctx}/business/payment?methodtype=searchBySupplierId";
		url = url + "&sessionFlag="+sessionFlag;
		url = url + "&finishStatus=010";
		...
		<div id="main">
			...
			<div id="search">
				...
				<form id="condition"  style='padding: 0px; margin: 10px;' >
					...
					<input type="hidden" id="supplierId" value="${supplierId }"><!-- 供应商 -->
<!-- 
					<table>
						<tr>
							<td width="50px"></td> 
