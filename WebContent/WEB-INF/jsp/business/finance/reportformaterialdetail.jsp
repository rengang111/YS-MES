...
<script type="text/javascript">
	...
	function ajax(status,sessionFlag) {
		...
		var actionUrl = "${ctx}/business/financereport?methodtype=reportForMaterialDetail";
...
<div id="main">
	...
	<table>
		...
		<tr>
			<td><input type="text" id="materialId"  class="read-only"/></td>			 
			<td><input type="text" id="materialName"  class="read-only"/></td>			 
			<td><input type="text" id="quantity"  class="read-only"/></td>	
			<td><input type="text" id="price"  class="read-only"/></td>	
			<td><input type="text" id="total"  class="read-only"/></td>
		</tr>
	</table>
	<div class="list">
