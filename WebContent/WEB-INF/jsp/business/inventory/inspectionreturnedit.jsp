	...
	$(document).ready(function() {
		...
		$("#update").click(
				function() {
					...
					$('#formModel').attr("action", "${ctx}/business/inspectionReturn?methodtype=update"+"&keyBackup="+keyBackup);
					$('#formModel').submit();
		});
...
<form:form modelAttribute="formModel" method="POST"
	...
	<form:hidden path="inspectReturn.inspectionreturnid" value="${arrived.inspectionReturnId }"/>
	<form:hidden path="inspectReturn.ysid" value="${arrived.YSId }"/>
	<form:hidden path="inspectReturn.parentid" value="${arrived.parentId }"/>
	<form:hidden path="inspectReturn.subid" value="${arrived.subId }"/>
	...
	<form:hidden path="inspectReturn.supplierid" value="${arrived.supplierId }"/>
		...
		<tbody>
			<c:forEach var="list" items="${material}" varStatus='status' >
					...
					<tr>
						...
						<td><span><form:input path="inspectReturnList[${status.index}].returnquantity" value="${list.returnQuantity }" class="num short quantity"/></span></td>
						
						<form:hidden path="inspectReturnList[${status.index}].recordid" value="${list.recordId }"/>
					</tr>
					<script type="text/javascript">
