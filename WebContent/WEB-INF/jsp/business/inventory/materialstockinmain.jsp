...
<script type="text/javascript">
	...
	function ajax(requisitionSts,sessionFlag) {
		...
		var url = "${ctx}/business/storage?methodtype=materialStockinMainSearch"
		...
		var t = $('#TMaterial').DataTable({
				...
				"columns": [
							...
							{"data": "remarks","className" : '', "defaultContent" : ''},
	...
	function doShow(receiptId) {
		...
		var url = '${ctx}/business/storage?methodtype=materialStockinDetailView'
				+"&receiptId="+receiptId;
	...
	function doCreate() {
		...
		var url = '${ctx}/business/storage?methodtype=materialStockinAddInit';
		...
		<!-- 		<div id="DTTT_container" style="height:40px;margin-bottom: -10px;float:left">
				...
				<div style="height: 40px;margin-bottom: -15px;float:right">
					<button type="button" id="zzcreate" class="DTTT_button" 
						style="width:120px" onclick="doCreate();">物料直接入库</button>
				</div>
				<table  style="width: 100%;" id="TMaterial" class="display dataTable">
					<thead>						
						<tr>
							<th style="width: 30px;">No</th>
							<th style="width: 80px;">入库单单编号</th>
