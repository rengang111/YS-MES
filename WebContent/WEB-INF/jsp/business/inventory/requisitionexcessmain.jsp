...
<script type="text/javascript">
	...
	function doCreate() {
		var virtualClass = $('#virtualClass').val();
		var url = "${ctx}/business/requisition?methodtype=excessAddInit"+"&virtualClass="+virtualClass;
		location.href = url;		
	};
...
<div id="main">
	...
	<div class="list">
		<div id="DTTT_container" style="height:40px;float: right">
			<a  class="DTTT_button " onclick="doCreate();"><span>超领录入</span></a>
		</div>
