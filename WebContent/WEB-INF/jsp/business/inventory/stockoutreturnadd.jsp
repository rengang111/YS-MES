		...
		<fieldset>
			...
			<table class="form" id="table_form">
				<tr> 				
					...
					<td colspan="5">
						<form:input path="requisition.ysid" class="middel" />
				...
				<tbody>
					<c:forEach var="i" begin="0" end="2" step="1">
						<tr>
							...
							<td><form:input path="requisitionList[${i}].materialid" value=""  class="materialid middle" /></td>								
							<td><span></span></td>					
							<td><span></span></td>
							<td><form:input path="requisitionList[${i}].quantity" value="" class="quantity num short"/></td>
						</tr>
							<script type="text/javascript">
...
$("#requisition\\.ysid").autocomplete({
	...
	select : function(event, ui) {//选择物料分类后,自动添加流水号IPid
		...
		$('#materialName').html(ui.item.materialName);
...
function autocomplete(){
	...
	$('.materialid').bind('input propertychange', function() {
