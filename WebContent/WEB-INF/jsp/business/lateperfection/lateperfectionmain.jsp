...
<script type="text/javascript">
	...
	function ajax() {
		...
		var t = $('#TLatePerfection').DataTable({
				"paging": true,
	...
	function initEvent(){
		...
		$('#TLatePerfection').DataTable().on('click', 'tr', function() {
			
			if ( $(this).hasClass('selected') ) {
	            $(this).removeClass('selected');
	        }
	        else {
	        	$('#TLatePerfection').DataTable().$('tr.selected').removeClass('selected');
	            $(this).addClass('selected');
	        }
		});
		
		/*
		$('#TLatePerfection').DataTable().on('dblclick', 'tr', function() {

			var d = $('#TLatePerfection').DataTable().row(this).data();
	...
	function reload() {
		...
		$('#TLatePerfection').DataTable().ajax.reload(null,false);
...
<div id="container">
		...
		<div id="main">
			...
			<div class="list">
				...
				<div id="TLatePerfection_wrapper" class="dataTables_wrapper">
					...
					<div id="clear"></div>
					<table aria-describedby="TLatePerfection_info" style="width: 100%;" id="TLatePerfection" class="display dataTable" cellspacing="0">
						<thead>
