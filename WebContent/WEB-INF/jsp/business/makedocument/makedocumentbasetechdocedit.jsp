...
function doSave() {
	...
	if (validator.form()) {
		...
		//修正
		actionUrl = "${ctx}/business/makedocument?methodtype=updatebasetechdoc";
		...
		if (confirm(message)) {
			...
			$.ajax({
				...
				success : function(d) {
					var valueArray = d.info.split("|");
					parent.reloadBaseTechDoc(valueArray[0]);
				...
				<form:form modelAttribute="dataModels" id="BaseTechDocInfo" style='padding: 0px; margin: 10px;' >
					...
					<table class="form" width="850px">
						<tr>
							...
							<td width="200px">
								<input type="text" id="title" name="title" class="short" value="${DisplayData.baseTechDocData.title}"/>
							</td>
						</tr>					
						<tr>
							<td width="60px">文件名：</td>
							<td width="200px">
								<input type="text" id="fileName" name="fileName" class="short" value="${DisplayData.baseTechDocData.filename}"/>
							</td>
						</tr>
						<tr>
							<td width="60px">路径：</td> 
							<td width="200px">
								<input type="text" id="path" name="path" class="middle" value="${DisplayData.baseTechDocData.path}"/>
							</td>
						</tr>
						<tr>
							<td>说明：</td> 
							<td width="200px">
								<input type="text" id="memo" name="memo" class="middle" value="${DisplayData.baseTechDocData.memo}"/>
							</td>
						</tr>
					</table>
