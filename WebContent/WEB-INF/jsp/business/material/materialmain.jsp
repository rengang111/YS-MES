		...
		var t = $('#TMaterial').DataTable({
				...
				"columnDefs":[
				    		...
				    		{"targets":5,"render":function(data, type, row){
				    			var rtn = "";
				    			var space = '&nbsp;';
				    			rtn= "<a href=\"#\" onClick=\"doShow('" + row["recordId"] +"','"+ row["parentId"] + "')\">查看</a>"+space;
					...
					<table aria-describedby="TSupplier_info" style="width: 100%;" id="TMaterial" class="display dataTable" cellspacing="0">
						<thead>						
							<tr class="selected">
								...
								<th colspan="1" rowspan="1" style="width: 150px;" aria-label="物料名称" class="dt-middle sorting_disabled">物料名称</th>
								<th colspan="1" rowspan="1" style="width: 120px;" aria-label="分类解释" class="dt-middle sorting_disabled">物料分类</th>
								<th colspan="1" rowspan="1" style="width: 30px;" aria-label="计量单位" class="dt-middle sorting_disabled">计量单位</th>
