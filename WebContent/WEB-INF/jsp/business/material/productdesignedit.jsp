...
<script type="text/javascript">
	//塑料制品
	var plasticCont = 0;
	var dbCnt2 = '${plasticCount}';
	if(dbCnt2 >0 ){
		plasticCont = Number(dbCnt2)-1;
	}
...
<script type="text/javascript">
	//文字印刷
	var textPrintCont = 0;
	var dbCnt5 = '${textPrintCount}';
	if(dbCnt5 >0 ){
		textPrintCont = Number(dbCnt5)-1;
	}
...
<fieldset>
	...
	<table id="plastic" class="display" >
		...
		<tbody>
			<c:forEach var="list" items="${plasticList}" varStatus="status">
				<tr>
					<td></td>
