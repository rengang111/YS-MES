	...
	<div>
		<div class="easyui-panel" style="padding:5px;width:300px;height:400px;">
		    ...
		    <ul id="deptTree" class="easyui-tree" data-options="animate:false,border:false,checkbox:true"></ul>
			 -->
			 <ul id="deptTree" class="easyui-tree" data-options="animate:false,border:false,checkbox:true,cascadeCheck:false"></ul>
			 <ul id="deptTreeNoCheck" class="easyui-tree" data-options="animate:false,border:false,checkbox:false"></ul>
...
<script type="text/javascript" >
    //树形菜单所需要的基本数据。
  	...
  	var oldId = "";
  	var menuId = "";
  	var initDeptUrl = "${ctx}/mainframe/initDept?menuId=";
	var launchNaviUrl = "${ctx}/mainframe/launchDept";
	...
	function noticeChange(node, isCheckBoxFlag) {
		...
		if (value != oldId) {
			oldId = value;
			/*
			if (deptObjName != null && deptObjName != "") {
				//alert(deptObjName);
				window.opener.document.getElementById(deptObjName).value = value;
				//alert(window.opener.document.getElementById(deptObjName).value);
			}
