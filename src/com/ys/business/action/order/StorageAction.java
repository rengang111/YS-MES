...
public class StorageAction extends BaseAction {
	...
	public String execute(@RequestBody String data, 
		...
		switch(type) {
			...
			case "printReceiptLabel"://打印标贴
				...
				break;
			case "printReceiptLabel2"://打印标贴(待入库)
				doPrintReceiptLabel2();
				rtnUrl = "/business/inventory/storageprintlabel2";
				break;
	...
	public void doPrintReceiptLabel2(){
		try{
			service.doPrintReceiptLabel2();
		}catch(Exception e){
			System.out.println(e.getMessage());
		}
	}
