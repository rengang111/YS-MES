...
public class B_ArrivalDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_Arrival( recordid,arrivalid,ysid,contractid,supplierid,materialid,status,quantity,arrivedate,userid,remarks,arrivaltype,stockintype,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,arrivalid,ysid,contractid,supplierid,materialid,status,quantity,arrivedate,userid,remarks,arrivaltype,stockintype,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Arrival WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,arrivalid,ysid,contractid,supplierid,materialid,status,quantity,arrivedate,userid,remarks,arrivaltype,stockintype,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Arrival"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,arrivalid,ysid,contractid,supplierid,materialid,status,quantity,arrivedate,userid,remarks,arrivaltype,stockintype,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Arrival" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_Arrival SET recordid= ? , arrivalid= ? , ysid= ? , contractid= ? , supplierid= ? , materialid= ? , status= ? , quantity= ? , arrivedate= ? , userid= ? , remarks= ? , arrivaltype= ? , stockintype= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getArrivalid());			statement.setString( 3,beanData.getYsid());			statement.setString( 4,beanData.getContractid());			statement.setString( 5,beanData.getSupplierid());			statement.setString( 6,beanData.getMaterialid());			statement.setString( 7,beanData.getStatus());			statement.setString( 8,beanData.getQuantity());			if (beanData.getArrivedate()==null || beanData.getArrivedate().trim().equals(""))			{				statement.setNull( 9, Types.DATE);			}			else			{				statement.setString( 9, beanData.getArrivedate());			}			statement.setString( 10,beanData.getUserid());			statement.setString( 11,beanData.getRemarks());			statement.setString( 12,beanData.getArrivaltype());			statement.setString( 13,beanData.getStockintype());			statement.setString( 14,beanData.getDeptguid());			statement.setString( 15,beanData.getCreatetime());			statement.setString( 16,beanData.getCreateperson());			statement.setString( 17,beanData.getCreateunitid());			statement.setString( 18,beanData.getModifytime());			statement.setString( 19,beanData.getModifyperson());			statement.setString( 20,beanData.getDeleteflag());			statement.setString( 21,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_Arrival SET recordid= ? , arrivalid= ? , ysid= ? , contractid= ? , supplierid= ? , materialid= ? , status= ? , quantity= ? , arrivedate= ? , userid= ? , remarks= ? , arrivaltype= ? , stockintype= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
