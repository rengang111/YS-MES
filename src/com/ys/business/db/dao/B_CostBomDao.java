...
public class B_CostBomDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_CostBom( recordid,bomid,ysid,materialid,parentid,subid,currency,exchangerate,cost,rebate,rebaterate,rmbprice,profitrate,profit,accountingdate,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_CostBom( recordid,bomid,ysid,materialid,parentid,subid,currency,exchangerate,cost,rebate,rebaterate,rmbprice,profitrate,profit,accountingdate,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,bomid,ysid,materialid,parentid,subid,currency,exchangerate,cost,rebate,rebaterate,rmbprice,profitrate,profit,accountingdate,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_CostBom WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,bomid,ysid,materialid,parentid,subid,currency,exchangerate,cost,rebate,rebaterate,rmbprice,profitrate,profit,accountingdate,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_CostBom"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,bomid,ysid,materialid,parentid,subid,currency,exchangerate,cost,rebate,rebaterate,rmbprice,profitrate,profit,accountingdate,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_CostBom" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_CostBom SET recordid= ? , bomid= ? , ysid= ? , materialid= ? , parentid= ? , subid= ? , currency= ? , exchangerate= ? , cost= ? , rebate= ? , rebaterate= ? , rmbprice= ? , profitrate= ? , profit= ? , accountingdate= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getBomid());			statement.setString( 3,beanData.getYsid());			statement.setString( 4,beanData.getMaterialid());			statement.setString( 5,beanData.getParentid());			statement.setString( 6,beanData.getSubid());			statement.setString( 7,beanData.getCurrency());			statement.setString( 8,beanData.getExchangerate());			statement.setString( 9,beanData.getCost());			statement.setString( 10,beanData.getRebate());			statement.setString( 11,beanData.getRebaterate());			statement.setString( 12,beanData.getRmbprice());			statement.setString( 13,beanData.getProfitrate());			statement.setString( 14,beanData.getProfit());			if (beanData.getAccountingdate()==null || beanData.getAccountingdate().trim().equals(""))			{				statement.setNull( 15, Types.DATE);			}			else			{				statement.setString( 15, beanData.getAccountingdate());			}			statement.setString( 16,beanData.getDeptguid());			statement.setString( 17,beanData.getCreatetime());			statement.setString( 18,beanData.getCreateperson());			statement.setString( 19,beanData.getCreateunitid());			statement.setString( 20,beanData.getModifytime());			statement.setString( 21,beanData.getModifyperson());			statement.setString( 22,beanData.getDeleteflag());			statement.setString( 23,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_CostBom SET recordid= ? , bomid= ? , ysid= ? , materialid= ? , parentid= ? , subid= ? , currency= ? , exchangerate= ? , cost= ? , rebate= ? , rebaterate= ? , rmbprice= ? , profitrate= ? , profit= ? , accountingdate= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
