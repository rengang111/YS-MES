...
public class B_CustomerDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_Customer( recordid,customerid,shortname,customername,parentid,subid,paymentterm,country,currency,shippingcondition,shippiingport,destinationport,rebate,commission,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_Customer( recordid,customerid,shortname,customername,parentid,subid,paymentterm,country,currency,shippingcondition,shippiingport,destinationport,rebate,commission,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,customerid,shortname,customername,parentid,subid,paymentterm,country,currency,shippingcondition,shippiingport,destinationport,rebate,commission,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Customer WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,customerid,shortname,customername,parentid,subid,paymentterm,country,currency,shippingcondition,shippiingport,destinationport,rebate,commission,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Customer"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,customerid,shortname,customername,parentid,subid,paymentterm,country,currency,shippingcondition,shippiingport,destinationport,rebate,commission,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Customer" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_Customer SET recordid= ? , customerid= ? , shortname= ? , customername= ? , parentid= ? , subid= ? , paymentterm= ? , country= ? , currency= ? , shippingcondition= ? , shippiingport= ? , destinationport= ? , rebate= ? , commission= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getCustomerid());			statement.setString( 3,beanData.getShortname());			statement.setString( 4,beanData.getCustomername());			statement.setString( 5,beanData.getParentid());			statement.setString( 6,beanData.getSubid());			statement.setString( 7,beanData.getPaymentterm());			statement.setString( 8,beanData.getCountry());			statement.setString( 9,beanData.getCurrency());			statement.setString( 10,beanData.getShippingcondition());			statement.setString( 11,beanData.getShippiingport());			statement.setString( 12,beanData.getDestinationport());			statement.setString( 13,beanData.getRebate());			statement.setString( 14,beanData.getCommission());			statement.setString( 15,beanData.getDeptguid());			statement.setString( 16,beanData.getCreatetime());			statement.setString( 17,beanData.getCreateperson());			statement.setString( 18,beanData.getCreateunitid());			statement.setString( 19,beanData.getModifytime());			statement.setString( 20,beanData.getModifyperson());			statement.setString( 21,beanData.getDeleteflag());			statement.setString( 22,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_Customer SET recordid= ? , customerid= ? , shortname= ? , customername= ? , parentid= ? , subid= ? , paymentterm= ? , country= ? , currency= ? , shippingcondition= ? , shippiingport= ? , destinationport= ? , rebate= ? , commission= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
