...
public class B_InspectionReturnDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_InspectionReturn( recordid,inspectionreturnid,parentid,subid,ysid,contractid,arrivalid,supplierid,materialid,returnquantity,checkerid,returndate,status,returntype,remarks,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,inspectionreturnid,parentid,subid,ysid,contractid,arrivalid,supplierid,materialid,returnquantity,checkerid,returndate,status,returntype,remarks,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_InspectionReturn WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,inspectionreturnid,parentid,subid,ysid,contractid,arrivalid,supplierid,materialid,returnquantity,checkerid,returndate,status,returntype,remarks,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_InspectionReturn"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,inspectionreturnid,parentid,subid,ysid,contractid,arrivalid,supplierid,materialid,returnquantity,checkerid,returndate,status,returntype,remarks,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_InspectionReturn" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_InspectionReturn SET recordid= ? , inspectionreturnid= ? , parentid= ? , subid= ? , ysid= ? , contractid= ? , arrivalid= ? , supplierid= ? , materialid= ? , returnquantity= ? , checkerid= ? , returndate= ? , status= ? , returntype= ? , remarks= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getInspectionreturnid());			statement.setString( 3,beanData.getParentid());			statement.setString( 4,beanData.getSubid());			statement.setString( 5,beanData.getYsid());			statement.setString( 6,beanData.getContractid());			statement.setString( 7,beanData.getArrivalid());			statement.setString( 8,beanData.getSupplierid());			statement.setString( 9,beanData.getMaterialid());			statement.setString( 10,beanData.getReturnquantity());			statement.setString( 11,beanData.getCheckerid());			statement.setString( 12,beanData.getReturndate());			statement.setString( 13,beanData.getStatus());			statement.setString( 14,beanData.getReturntype());			statement.setString( 15,beanData.getRemarks());			statement.setString( 16,beanData.getDeptguid());			statement.setString( 17,beanData.getCreatetime());			statement.setString( 18,beanData.getCreateperson());			statement.setString( 19,beanData.getCreateunitid());			statement.setString( 20,beanData.getModifytime());			statement.setString( 21,beanData.getModifyperson());			statement.setString( 22,beanData.getDeleteflag());			statement.setString( 23,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_InspectionReturn SET recordid= ? , inspectionreturnid= ? , parentid= ? , subid= ? , ysid= ? , contractid= ? , arrivalid= ? , supplierid= ? , materialid= ? , returnquantity= ? , checkerid= ? , returndate= ? , status= ? , returntype= ? , remarks= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
