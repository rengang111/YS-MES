...
public class B_MaterialDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_Material( recordid,materialid,serialnumber,materialname,categoryid,description,sharemodel,unit,parentid,subid,subiddes,productmodel,customerid,image_filename,purchasetype,originalid,safetyinventory,waitstockin,waitstockout,quantityonhand,availabeltopromise,accountingquantity,maprice,beginninginventory,beginningprice,quantityeditflag,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,materialid,serialnumber,materialname,categoryid,description,sharemodel,unit,parentid,subid,subiddes,productmodel,customerid,image_filename,purchasetype,originalid,safetyinventory,waitstockin,waitstockout,quantityonhand,availabeltopromise,accountingquantity,maprice,beginninginventory,beginningprice,quantityeditflag,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Material WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,materialid,serialnumber,materialname,categoryid,description,sharemodel,unit,parentid,subid,subiddes,productmodel,customerid,image_filename,purchasetype,originalid,safetyinventory,waitstockin,waitstockout,quantityonhand,availabeltopromise,accountingquantity,maprice,beginninginventory,beginningprice,quantityeditflag,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Material"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,materialid,serialnumber,materialname,categoryid,description,sharemodel,unit,parentid,subid,subiddes,productmodel,customerid,image_filename,purchasetype,originalid,safetyinventory,waitstockin,waitstockout,quantityonhand,availabeltopromise,accountingquantity,maprice,beginninginventory,beginningprice,quantityeditflag,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Material" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_Material SET recordid= ? , materialid= ? , serialnumber= ? , materialname= ? , categoryid= ? , description= ? , sharemodel= ? , unit= ? , parentid= ? , subid= ? , subiddes= ? , productmodel= ? , customerid= ? , image_filename= ? , purchasetype= ? , originalid= ? , safetyinventory= ? , waitstockin= ? , waitstockout= ? , quantityonhand= ? , availabeltopromise= ? , accountingquantity= ? , maprice= ? , beginninginventory= ? , beginningprice= ? , quantityeditflag= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getMaterialid());			statement.setString( 3,beanData.getSerialnumber());			statement.setString( 4,beanData.getMaterialname());			statement.setString( 5,beanData.getCategoryid());			statement.setString( 6,beanData.getDescription());			statement.setString( 7,beanData.getSharemodel());			statement.setString( 8,beanData.getUnit());			statement.setString( 9,beanData.getParentid());			statement.setString( 10,beanData.getSubid());			statement.setString( 11,beanData.getSubiddes());			statement.setString( 12,beanData.getProductmodel());			statement.setString( 13,beanData.getCustomerid());			statement.setString( 14,beanData.getImage_filename());			statement.setString( 15,beanData.getPurchasetype());			statement.setString( 16,beanData.getOriginalid());			statement.setString( 17,beanData.getSafetyinventory());			statement.setString( 18,beanData.getWaitstockin());			statement.setString( 19,beanData.getWaitstockout());			statement.setString( 20,beanData.getQuantityonhand());			statement.setString( 21,beanData.getAvailabeltopromise());			statement.setString( 22,beanData.getAccountingquantity());			statement.setString( 23,beanData.getMaprice());			statement.setString( 24,beanData.getBeginninginventory());			statement.setString( 25,beanData.getBeginningprice());			statement.setString( 26,beanData.getQuantityeditflag());			statement.setString( 27,beanData.getDeptguid());			statement.setString( 28,beanData.getCreatetime());			statement.setString( 29,beanData.getCreateperson());			statement.setString( 30,beanData.getCreateunitid());			statement.setString( 31,beanData.getModifytime());			statement.setString( 32,beanData.getModifyperson());			statement.setString( 33,beanData.getDeleteflag());			statement.setString( 34,beanData.getFormid());
			statement.setString( 35,beanData.getRecordid());
			if (statement.executeUpdate() < 1)
				throw new Exception(" Row Not does; ");
		}
		catch(Exception e)
		{
			throw new Exception("UPDATE B_Material SET recordid= ? , materialid= ? , serialnumber= ? , materialname= ? , categoryid= ? , description= ? , sharemodel= ? , unit= ? , parentid= ? , subid= ? , subiddes= ? , productmodel= ? , customerid= ? , image_filename= ? , purchasetype= ? , originalid= ? , safetyinventory= ? , waitstockin= ? , waitstockout= ? , quantityonhand= ? , availabeltopromise= ? , accountingquantity= ? , maprice= ? , beginninginventory= ? , beginningprice= ? , quantityeditflag= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
