...
public class B_MaterialStorageHistoryDao extends BaseAbstractDao
{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,materialid,serialnumber,materialname,categoryid,description,sharemodel,unit,parentid,subid,subiddes,productmodel,customerid,image_filename,purchasetype,originalid,safetyinventory,waitstockin,waitstockout,quantityonhand,availabeltopromise,accountingquantity,maprice,beginningwaitin,beginningwaitout,beginningavailabel,beginninginventory,beginningprice,quantityeditflag,stocktype,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_MaterialStorageHistory WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,materialid,serialnumber,materialname,categoryid,description,sharemodel,unit,parentid,subid,subiddes,productmodel,customerid,image_filename,purchasetype,originalid,safetyinventory,waitstockin,waitstockout,quantityonhand,availabeltopromise,accountingquantity,maprice,beginningwaitin,beginningwaitout,beginningavailabel,beginninginventory,beginningprice,quantityeditflag,stocktype,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_MaterialStorageHistory  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,materialid,serialnumber,materialname,categoryid,description,sharemodel,unit,parentid,subid,subiddes,productmodel,customerid,image_filename,purchasetype,originalid,safetyinventory,waitstockin,waitstockout,quantityonhand,availabeltopromise,accountingquantity,maprice,beginningwaitin,beginningwaitout,beginningavailabel,beginninginventory,beginningprice,quantityeditflag,stocktype,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_MaterialStorageHistory"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,materialid,serialnumber,materialname,categoryid,description,sharemodel,unit,parentid,subid,subiddes,productmodel,customerid,image_filename,purchasetype,originalid,safetyinventory,waitstockin,waitstockout,quantityonhand,availabeltopromise,accountingquantity,maprice,beginningwaitin,beginningwaitout,beginningavailabel,beginninginventory,beginningprice,quantityeditflag,stocktype,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_MaterialStorageHistory" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
