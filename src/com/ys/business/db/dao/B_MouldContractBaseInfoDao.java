...
public class B_MouldContractBaseInfoDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_MouldContractBaseInfo( id,contractid,contractyear,productmodelid,type,supplierid,contractdate,deliverdate,belong,oursidepay,providerpay,returncase,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		...
		{
			throw new Exception("INSERT INTO B_MouldContractBaseInfo( id,contractid,contractyear,productmodelid,type,supplierid,contractdate,deliverdate,belong,oursidepay,providerpay,returncase,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)："+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_MouldContractBaseInfo( id,contractid,contractyear,productmodelid,type,supplierid,contractdate,deliverdate,belong,oursidepay,providerpay,returncase,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT id,contractid,contractyear,productmodelid,type,supplierid,contractdate,deliverdate,belong,oursidepay,providerpay,returncase,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_MouldContractBaseInfo WHERE  id =?");
			statement.setString( 1,beanData.getId());
		...
		{
			throw new Exception("Error executing SQL SELECT id,contractid,contractyear,productmodelid,type,supplierid,contractdate,deliverdate,belong,oursidepay,providerpay,returncase,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_MouldContractBaseInfo  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT id,contractid,contractyear,productmodelid,type,supplierid,contractdate,deliverdate,belong,oursidepay,providerpay,returncase,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_MouldContractBaseInfo"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT id,contractid,contractyear,productmodelid,type,supplierid,contractdate,deliverdate,belong,oursidepay,providerpay,returncase,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_MouldContractBaseInfo" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_MouldContractBaseInfo SET id= ? , contractid= ? , contractyear= ? , productmodelid= ? , type= ? , supplierid= ? , contractdate= ? , deliverdate= ? , belong= ? , oursidepay= ? , providerpay= ? , returncase= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  id  = ?");
			statement.setString( 1,beanData.getId());			statement.setString( 2,beanData.getContractid());			statement.setString( 3,beanData.getContractyear());			statement.setString( 4,beanData.getProductmodelid());			statement.setString( 5,beanData.getType());			statement.setString( 6,beanData.getSupplierid());			statement.setString( 7,beanData.getContractdate());			statement.setString( 8,beanData.getDeliverdate());			statement.setString( 9,beanData.getBelong());			statement.setString( 10,beanData.getOursidepay());			statement.setString( 11,beanData.getProviderpay());			statement.setString( 12,beanData.getReturncase());			statement.setString( 13,beanData.getDeptguid());			statement.setString( 14,beanData.getCreatetime());			statement.setString( 15,beanData.getCreateperson());			statement.setString( 16,beanData.getCreateunitid());			statement.setString( 17,beanData.getModifytime());			statement.setString( 18,beanData.getModifyperson());			statement.setString( 19,beanData.getDeleteflag());
		...
		{
			throw new Exception("UPDATE B_MouldContractBaseInfo SET id= ? , contractid= ? , contractyear= ? , productmodelid= ? , type= ? , supplierid= ? , contractdate= ? , deliverdate= ? , belong= ? , oursidepay= ? , providerpay= ? , returncase= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  id  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
