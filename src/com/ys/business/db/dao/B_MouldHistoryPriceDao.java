...
public class B_MouldHistoryPriceDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_MouldHistoryPrice( id,mouldid,mouldfactoryid,price,priceunit,currency,pricetime,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		...
		{
			throw new Exception("INSERT INTO B_MouldHistoryPrice( id,mouldid,mouldfactoryid,price,priceunit,currency,pricetime,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)："+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_MouldHistoryPrice( id,mouldid,mouldfactoryid,price,priceunit,currency,pricetime,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT id,mouldid,mouldfactoryid,price,priceunit,currency,pricetime,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_MouldHistoryPrice WHERE  id =?");
			statement.setString( 1,beanData.getId());
		...
		{
			throw new Exception("Error executing SQL SELECT id,mouldid,mouldfactoryid,price,priceunit,currency,pricetime,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_MouldHistoryPrice  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT id,mouldid,mouldfactoryid,price,priceunit,currency,pricetime,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_MouldHistoryPrice"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT id,mouldid,mouldfactoryid,price,priceunit,currency,pricetime,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_MouldHistoryPrice" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_MouldHistoryPrice SET id= ? , mouldid= ? , mouldfactoryid= ? , price= ? , priceunit= ? , currency= ? , pricetime= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  id  = ?");
			statement.setString( 1,beanData.getId());			statement.setString( 2,beanData.getMouldid());			statement.setString( 3,beanData.getMouldfactoryid());			statement.setString( 4,beanData.getPrice());			statement.setString( 5,beanData.getPriceunit());			statement.setString( 6,beanData.getCurrency());			statement.setString( 7,beanData.getPricetime());			statement.setString( 8,beanData.getDeptguid());			statement.setString( 9,beanData.getCreatetime());			statement.setString( 10,beanData.getCreateperson());			statement.setString( 11,beanData.getCreateunitid());			statement.setString( 12,beanData.getModifytime());			statement.setString( 13,beanData.getModifyperson());			statement.setString( 14,beanData.getDeleteflag());
		...
		{
			throw new Exception("UPDATE B_MouldHistoryPrice SET id= ? , mouldid= ? , mouldfactoryid= ? , price= ? , priceunit= ? , currency= ? , pricetime= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  id  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
