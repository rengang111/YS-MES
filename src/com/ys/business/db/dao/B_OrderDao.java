...
public class B_OrderDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_Order( recordid,piid,parentid,subid,customerid,orderid,currency,shippingcase,paymentterm,loadingport,deliveryport,orderdate,deliverydate,totalprice,yskordertarget,team,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_Order( recordid,piid,parentid,subid,customerid,orderid,currency,shippingcase,paymentterm,loadingport,deliveryport,orderdate,deliverydate,totalprice,yskordertarget,team,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,piid,parentid,subid,customerid,orderid,currency,shippingcase,paymentterm,loadingport,deliveryport,orderdate,deliverydate,totalprice,yskordertarget,team,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Order WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,piid,parentid,subid,customerid,orderid,currency,shippingcase,paymentterm,loadingport,deliveryport,orderdate,deliverydate,totalprice,yskordertarget,team,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Order"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,piid,parentid,subid,customerid,orderid,currency,shippingcase,paymentterm,loadingport,deliveryport,orderdate,deliverydate,totalprice,yskordertarget,team,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Order" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			throw new Exception("UPDATE B_Order SET recordid= ? , piid= ? , parentid= ? , subid= ? , customerid= ? , orderid= ? , currency= ? , shippingcase= ? , paymentterm= ? , loadingport= ? , deliveryport= ? , orderdate= ? , deliverydate= ? , totalprice= ? , yskordertarget= ? , team= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
