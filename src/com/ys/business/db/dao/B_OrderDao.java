...
public class B_OrderDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_Order( recordid,piid,parentid,subid,customerid,orderid,shippingcase,paymentterm,loadingport,deliveryport,ordercompany,orderdate,deliverydate,totalprice,yskordertarget,ordernature,team,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,piid,parentid,subid,customerid,orderid,shippingcase,paymentterm,loadingport,deliveryport,ordercompany,orderdate,deliverydate,totalprice,yskordertarget,ordernature,team,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Order WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,piid,parentid,subid,customerid,orderid,shippingcase,paymentterm,loadingport,deliveryport,ordercompany,orderdate,deliverydate,totalprice,yskordertarget,ordernature,team,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Order"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,piid,parentid,subid,customerid,orderid,shippingcase,paymentterm,loadingport,deliveryport,ordercompany,orderdate,deliverydate,totalprice,yskordertarget,ordernature,team,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Order" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_Order SET recordid= ? , piid= ? , parentid= ? , subid= ? , customerid= ? , orderid= ? , shippingcase= ? , paymentterm= ? , loadingport= ? , deliveryport= ? , ordercompany= ? , orderdate= ? , deliverydate= ? , totalprice= ? , yskordertarget= ? , ordernature= ? , team= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getPiid());			statement.setString( 3,beanData.getParentid());			statement.setString( 4,beanData.getSubid());			statement.setString( 5,beanData.getCustomerid());			statement.setString( 6,beanData.getOrderid());			statement.setString( 7,beanData.getShippingcase());			statement.setString( 8,beanData.getPaymentterm());			statement.setString( 9,beanData.getLoadingport());			statement.setString( 10,beanData.getDeliveryport());			statement.setString( 11,beanData.getOrdercompany());			if (beanData.getOrderdate()==null || beanData.getOrderdate().trim().equals(""))			{				statement.setNull( 12, Types.DATE);			}			else			{				statement.setString( 12, beanData.getOrderdate());			}			if (beanData.getDeliverydate()==null || beanData.getDeliverydate().trim().equals(""))			{				statement.setNull( 13, Types.DATE);			}			else			{				statement.setString( 13, beanData.getDeliverydate());			}			statement.setString( 14,beanData.getTotalprice());			statement.setString( 15,beanData.getYskordertarget());			statement.setString( 16,beanData.getOrdernature());			statement.setString( 17,beanData.getTeam());			statement.setString( 18,beanData.getDeptguid());			statement.setString( 19,beanData.getCreatetime());			statement.setString( 20,beanData.getCreateperson());			statement.setString( 21,beanData.getCreateunitid());			statement.setString( 22,beanData.getModifytime());			statement.setString( 23,beanData.getModifyperson());			statement.setString( 24,beanData.getDeleteflag());			statement.setString( 25,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_Order SET recordid= ? , piid= ? , parentid= ? , subid= ? , customerid= ? , orderid= ? , shippingcase= ? , paymentterm= ? , loadingport= ? , deliveryport= ? , ordercompany= ? , orderdate= ? , deliverydate= ? , totalprice= ? , yskordertarget= ? , ordernature= ? , team= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
