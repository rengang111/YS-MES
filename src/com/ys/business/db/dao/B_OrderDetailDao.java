...
public class B_OrderDetailDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_OrderDetail( recordid,ysid,piid,parentid,subid,materialid,quantity,price,totalprice,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		...
		{
			throw new Exception("INSERT INTO B_OrderDetail( recordid,ysid,piid,parentid,subid,materialid,quantity,price,totalprice,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_OrderDetail( recordid,ysid,piid,parentid,subid,materialid,quantity,price,totalprice,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,ysid,piid,parentid,subid,materialid,quantity,price,totalprice,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_OrderDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,ysid,piid,parentid,subid,materialid,quantity,price,totalprice,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_OrderDetail  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,ysid,piid,parentid,subid,materialid,quantity,price,totalprice,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_OrderDetail"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,ysid,piid,parentid,subid,materialid,quantity,price,totalprice,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_OrderDetail" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_OrderDetail SET recordid= ? , ysid= ? , piid= ? , parentid= ? , subid= ? , materialid= ? , quantity= ? , price= ? , totalprice= ? , status= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getYsid());			statement.setString( 3,beanData.getPiid());			statement.setString( 4,beanData.getParentid());			statement.setString( 5,beanData.getSubid());			statement.setString( 6,beanData.getMaterialid());			statement.setString( 7,beanData.getQuantity());			statement.setString( 8,beanData.getPrice());			statement.setString( 9,beanData.getTotalprice());			statement.setString( 10,beanData.getStatus());			statement.setString( 11,beanData.getDeptguid());			statement.setString( 12,beanData.getCreatetime());			statement.setString( 13,beanData.getCreateperson());			statement.setString( 14,beanData.getCreateunitid());			statement.setString( 15,beanData.getModifytime());			statement.setString( 16,beanData.getModifyperson());			statement.setString( 17,beanData.getDeleteflag());			statement.setString( 18,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_OrderDetail SET recordid= ? , ysid= ? , piid= ? , parentid= ? , subid= ? , materialid= ? , quantity= ? , price= ? , totalprice= ? , status= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
