...
public class B_OrderDetailDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_OrderDetail( recordid,ysid,piid,parentid,subid,materialid,quantity,totalquantity,completedquantity,completednumber,stockoutqty,returnquantity,price,totalprice,currency,exchangerate,exchangeprice,rmbprice,salestax,rebate,rebaterate,profitrate,profit,salesprofit,adjustprofit,totalsalesprofit,totaladjustprofit,ordercost,netprofit,productcost,storagedate,stockoutdate,status,productclassify,ordertype,payment,receipt,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_OrderDetail( recordid,ysid,piid,parentid,subid,materialid,quantity,totalquantity,completedquantity,completednumber,stockoutqty,returnquantity,price,totalprice,currency,exchangerate,exchangeprice,rmbprice,salestax,rebate,rebaterate,profitrate,profit,salesprofit,adjustprofit,totalsalesprofit,totaladjustprofit,ordercost,netprofit,productcost,storagedate,stockoutdate,status,productclassify,ordertype,payment,receipt,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,ysid,piid,parentid,subid,materialid,quantity,totalquantity,completedquantity,completednumber,stockoutqty,returnquantity,price,totalprice,currency,exchangerate,exchangeprice,rmbprice,salestax,rebate,rebaterate,profitrate,profit,salesprofit,adjustprofit,totalsalesprofit,totaladjustprofit,ordercost,netprofit,productcost,storagedate,stockoutdate,status,productclassify,ordertype,payment,receipt,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_OrderDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,ysid,piid,parentid,subid,materialid,quantity,totalquantity,completedquantity,completednumber,stockoutqty,returnquantity,price,totalprice,currency,exchangerate,exchangeprice,rmbprice,salestax,rebate,rebaterate,profitrate,profit,salesprofit,adjustprofit,totalsalesprofit,totaladjustprofit,ordercost,netprofit,productcost,storagedate,stockoutdate,status,productclassify,ordertype,payment,receipt,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_OrderDetail"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,ysid,piid,parentid,subid,materialid,quantity,totalquantity,completedquantity,completednumber,stockoutqty,returnquantity,price,totalprice,currency,exchangerate,exchangeprice,rmbprice,salestax,rebate,rebaterate,profitrate,profit,salesprofit,adjustprofit,totalsalesprofit,totaladjustprofit,ordercost,netprofit,productcost,storagedate,stockoutdate,status,productclassify,ordertype,payment,receipt,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_OrderDetail" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_OrderDetail SET recordid= ? , ysid= ? , piid= ? , parentid= ? , subid= ? , materialid= ? , quantity= ? , totalquantity= ? , completedquantity= ? , completednumber= ? , stockoutqty= ? , returnquantity= ? , price= ? , totalprice= ? , currency= ? , exchangerate= ? , exchangeprice= ? , rmbprice= ? , salestax= ? , rebate= ? , rebaterate= ? , profitrate= ? , profit= ? , salesprofit= ? , adjustprofit= ? , totalsalesprofit= ? , totaladjustprofit= ? , ordercost= ? , netprofit= ? , productcost= ? , storagedate= ? , stockoutdate= ? , status= ? , productclassify= ? , ordertype= ? , payment= ? , receipt= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getYsid());			statement.setString( 3,beanData.getPiid());			statement.setString( 4,beanData.getParentid());			statement.setString( 5,beanData.getSubid());			statement.setString( 6,beanData.getMaterialid());			statement.setString( 7,beanData.getQuantity());			statement.setString( 8,beanData.getTotalquantity());			statement.setString( 9,beanData.getCompletedquantity());			statement.setString( 10,beanData.getCompletednumber());			statement.setString( 11,beanData.getStockoutqty());			statement.setString( 12,beanData.getReturnquantity());			statement.setString( 13,beanData.getPrice());			statement.setString( 14,beanData.getTotalprice());			statement.setString( 15,beanData.getCurrency());			statement.setString( 16,beanData.getExchangerate());			statement.setString( 17,beanData.getExchangeprice());			statement.setString( 18,beanData.getRmbprice());			statement.setString( 19,beanData.getSalestax());			statement.setString( 20,beanData.getRebate());			statement.setString( 21,beanData.getRebaterate());			statement.setString( 22,beanData.getProfitrate());			statement.setString( 23,beanData.getProfit());			statement.setString( 24,beanData.getSalesprofit());			statement.setString( 25,beanData.getAdjustprofit());			statement.setString( 26,beanData.getTotalsalesprofit());			statement.setString( 27,beanData.getTotaladjustprofit());			statement.setString( 28,beanData.getOrdercost());			statement.setString( 29,beanData.getNetprofit());			statement.setString( 30,beanData.getProductcost());			if (beanData.getStoragedate()==null || beanData.getStoragedate().trim().equals(""))			{				statement.setNull( 31, Types.DATE);			}			else			{				statement.setString( 31, beanData.getStoragedate());			}			if (beanData.getStockoutdate()==null || beanData.getStockoutdate().trim().equals(""))			{				statement.setNull( 32, Types.DATE);			}			else			{				statement.setString( 32, beanData.getStockoutdate());			}			statement.setString( 33,beanData.getStatus());			statement.setString( 34,beanData.getProductclassify());			statement.setString( 35,beanData.getOrdertype());			statement.setString( 36,beanData.getPayment());			statement.setString( 37,beanData.getReceipt());			statement.setString( 38,beanData.getDeptguid());			statement.setString( 39,beanData.getCreatetime());			statement.setString( 40,beanData.getCreateperson());			statement.setString( 41,beanData.getCreateunitid());			statement.setString( 42,beanData.getModifytime());			statement.setString( 43,beanData.getModifyperson());			statement.setString( 44,beanData.getDeleteflag());			statement.setString( 45,beanData.getFormid());
			statement.setString( 46,beanData.getRecordid());
			if (statement.executeUpdate() < 1)
				throw new Exception(" Row Not does; ");
		}
		catch(Exception e)
		{
			throw new Exception("UPDATE B_OrderDetail SET recordid= ? , ysid= ? , piid= ? , parentid= ? , subid= ? , materialid= ? , quantity= ? , totalquantity= ? , completedquantity= ? , completednumber= ? , stockoutqty= ? , returnquantity= ? , price= ? , totalprice= ? , currency= ? , exchangerate= ? , exchangeprice= ? , rmbprice= ? , salestax= ? , rebate= ? , rebaterate= ? , profitrate= ? , profit= ? , salesprofit= ? , adjustprofit= ? , totalsalesprofit= ? , totaladjustprofit= ? , ordercost= ? , netprofit= ? , productcost= ? , storagedate= ? , stockoutdate= ? , status= ? , productclassify= ? , ordertype= ? , payment= ? , receipt= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
