...
public class B_PaymentDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_Payment( recordid,paymentid,parentid,subid,requestdate,applicant,deptid,paymentterms,paymentmethod,currency,totalpayable,approvaluser,approvaldate,approvalstatus,approvalfeedback,invoicecheckuser,invoicecheckdate,invoicecheckstatus,invoicecheckfeedback,invoiceuser,invoicedate,invoicetype,invoicenumber,finishuser,finishdate,finishstatus,supplierid,contractids,paymenttype,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getPaymentid());			statement.setString( 3,beanData.getParentid());			statement.setString( 4,beanData.getSubid());			if (beanData.getRequestdate()==null || beanData.getRequestdate().trim().equals(""))			{				statement.setNull( 5, Types.DATE);			}			else			{				statement.setString( 5, beanData.getRequestdate());			}			statement.setString( 6,beanData.getApplicant());			statement.setString( 7,beanData.getDeptid());			statement.setString( 8,beanData.getPaymentterms());			statement.setString( 9,beanData.getPaymentmethod());			statement.setString( 10,beanData.getCurrency());			statement.setString( 11,beanData.getTotalpayable());			statement.setString( 12,beanData.getApprovaluser());			if (beanData.getApprovaldate()==null || beanData.getApprovaldate().trim().equals(""))			{				statement.setNull( 13, Types.DATE);			}			else			{				statement.setString( 13, beanData.getApprovaldate());			}			statement.setString( 14,beanData.getApprovalstatus());			statement.setString( 15,beanData.getApprovalfeedback());			statement.setString( 16,beanData.getInvoicecheckuser());			if (beanData.getInvoicecheckdate()==null || beanData.getInvoicecheckdate().trim().equals(""))			{				statement.setNull( 17, Types.DATE);			}			else			{				statement.setString( 17, beanData.getInvoicecheckdate());			}			statement.setString( 18,beanData.getInvoicecheckstatus());			statement.setString( 19,beanData.getInvoicecheckfeedback());			statement.setString( 20,beanData.getInvoiceuser());			if (beanData.getInvoicedate()==null || beanData.getInvoicedate().trim().equals(""))			{				statement.setNull( 21, Types.DATE);			}			else			{				statement.setString( 21, beanData.getInvoicedate());			}			statement.setString( 22,beanData.getInvoicetype());			statement.setString( 23,beanData.getInvoicenumber());			statement.setString( 24,beanData.getFinishuser());			if (beanData.getFinishdate()==null || beanData.getFinishdate().trim().equals(""))			{				statement.setNull( 25, Types.DATE);			}			else			{				statement.setString( 25, beanData.getFinishdate());			}			statement.setString( 26,beanData.getFinishstatus());			statement.setString( 27,beanData.getSupplierid());			statement.setString( 28,beanData.getContractids());			statement.setString( 29,beanData.getPaymenttype());			statement.setString( 30,beanData.getDeptguid());			statement.setString( 31,beanData.getCreatetime());			statement.setString( 32,beanData.getCreateperson());			statement.setString( 33,beanData.getCreateunitid());			statement.setString( 34,beanData.getModifytime());			statement.setString( 35,beanData.getModifyperson());			statement.setString( 36,beanData.getDeleteflag());			statement.setString( 37,beanData.getFormid());
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		try
		{
			...
			returnData.setRecordid( resultSet.getString( 1));			returnData.setPaymentid( resultSet.getString( 2));			returnData.setParentid( resultSet.getString( 3));			returnData.setSubid( resultSet.getString( 4));			returnData.setRequestdate( resultSet.getString( 5));			returnData.setApplicant( resultSet.getString( 6));			returnData.setDeptid( resultSet.getString( 7));			returnData.setPaymentterms( resultSet.getString( 8));			returnData.setPaymentmethod( resultSet.getString( 9));			returnData.setCurrency( resultSet.getString( 10));			returnData.setTotalpayable( resultSet.getString( 11));			returnData.setApprovaluser( resultSet.getString( 12));			returnData.setApprovaldate( resultSet.getString( 13));			returnData.setApprovalstatus( resultSet.getString( 14));			returnData.setApprovalfeedback( resultSet.getString( 15));			returnData.setInvoicecheckuser( resultSet.getString( 16));			returnData.setInvoicecheckdate( resultSet.getString( 17));			returnData.setInvoicecheckstatus( resultSet.getString( 18));			returnData.setInvoicecheckfeedback( resultSet.getString( 19));			returnData.setInvoiceuser( resultSet.getString( 20));			returnData.setInvoicedate( resultSet.getString( 21));			returnData.setInvoicetype( resultSet.getString( 22));			returnData.setInvoicenumber( resultSet.getString( 23));			returnData.setFinishuser( resultSet.getString( 24));			returnData.setFinishdate( resultSet.getString( 25));			returnData.setFinishstatus( resultSet.getString( 26));			returnData.setSupplierid( resultSet.getString( 27));			returnData.setContractids( resultSet.getString( 28));			returnData.setPaymenttype( resultSet.getString( 29));			returnData.setDeptguid( resultSet.getString( 30));			returnData.setCreatetime( resultSet.getString( 31));			returnData.setCreateperson( resultSet.getString( 32));			returnData.setCreateunitid( resultSet.getString( 33));			returnData.setModifytime( resultSet.getString( 34));			returnData.setModifyperson( resultSet.getString( 35));			returnData.setDeleteflag( resultSet.getString( 36));			returnData.setFormid( resultSet.getString( 37));
			return returnData;
		}
		catch(Exception e)
		{
	...
	public void Store()  throws Exception
	{
		...
		try
		{
			...
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getPaymentid());			statement.setString( 3,beanData.getParentid());			statement.setString( 4,beanData.getSubid());			if (beanData.getRequestdate()==null || beanData.getRequestdate().trim().equals(""))			{				statement.setNull( 5, Types.DATE);			}			else			{				statement.setString( 5, beanData.getRequestdate());			}			statement.setString( 6,beanData.getApplicant());			statement.setString( 7,beanData.getDeptid());			statement.setString( 8,beanData.getPaymentterms());			statement.setString( 9,beanData.getPaymentmethod());			statement.setString( 10,beanData.getCurrency());			statement.setString( 11,beanData.getTotalpayable());			statement.setString( 12,beanData.getApprovaluser());			if (beanData.getApprovaldate()==null || beanData.getApprovaldate().trim().equals(""))			{				statement.setNull( 13, Types.DATE);			}			else			{				statement.setString( 13, beanData.getApprovaldate());			}			statement.setString( 14,beanData.getApprovalstatus());			statement.setString( 15,beanData.getApprovalfeedback());			statement.setString( 16,beanData.getInvoicecheckuser());			if (beanData.getInvoicecheckdate()==null || beanData.getInvoicecheckdate().trim().equals(""))			{				statement.setNull( 17, Types.DATE);			}			else			{				statement.setString( 17, beanData.getInvoicecheckdate());			}			statement.setString( 18,beanData.getInvoicecheckstatus());			statement.setString( 19,beanData.getInvoicecheckfeedback());			statement.setString( 20,beanData.getInvoiceuser());			if (beanData.getInvoicedate()==null || beanData.getInvoicedate().trim().equals(""))			{				statement.setNull( 21, Types.DATE);			}			else			{				statement.setString( 21, beanData.getInvoicedate());			}			statement.setString( 22,beanData.getInvoicetype());			statement.setString( 23,beanData.getInvoicenumber());			statement.setString( 24,beanData.getFinishuser());			if (beanData.getFinishdate()==null || beanData.getFinishdate().trim().equals(""))			{				statement.setNull( 25, Types.DATE);			}			else			{				statement.setString( 25, beanData.getFinishdate());			}			statement.setString( 26,beanData.getFinishstatus());			statement.setString( 27,beanData.getSupplierid());			statement.setString( 28,beanData.getContractids());			statement.setString( 29,beanData.getPaymenttype());			statement.setString( 30,beanData.getDeptguid());			statement.setString( 31,beanData.getCreatetime());			statement.setString( 32,beanData.getCreateperson());			statement.setString( 33,beanData.getCreateunitid());			statement.setString( 34,beanData.getModifytime());			statement.setString( 35,beanData.getModifyperson());			statement.setString( 36,beanData.getDeleteflag());			statement.setString( 37,beanData.getFormid());
			statement.setString( 38,beanData.getRecordid());
			if (statement.executeUpdate() < 1)
				throw new Exception(" Row Not does; ");
		}
		catch(Exception e)
