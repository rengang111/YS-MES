...
public class B_PaymentDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_Payment( recordid,paymentid,parentid,subid,requestdate,applicant,deptid,paymentterms,paymentmethod,currency,totalpayable,approvaluser,approvaldate,approvalstatus,approvalfeedback,invoicenumber,finishuser,finishdate,finishstatus,supplierid,contractids,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,paymentid,parentid,subid,requestdate,applicant,deptid,paymentterms,paymentmethod,currency,totalpayable,approvaluser,approvaldate,approvalstatus,approvalfeedback,invoicenumber,finishuser,finishdate,finishstatus,supplierid,contractids,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Payment WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			...
			returnData.setRecordid( resultSet.getString( 1));			returnData.setPaymentid( resultSet.getString( 2));			returnData.setParentid( resultSet.getString( 3));			returnData.setSubid( resultSet.getString( 4));			returnData.setRequestdate( resultSet.getString( 5));			returnData.setApplicant( resultSet.getString( 6));			returnData.setDeptid( resultSet.getString( 7));			returnData.setPaymentterms( resultSet.getString( 8));			returnData.setPaymentmethod( resultSet.getString( 9));			returnData.setCurrency( resultSet.getString( 10));			returnData.setTotalpayable( resultSet.getString( 11));			returnData.setApprovaluser( resultSet.getString( 12));			returnData.setApprovaldate( resultSet.getString( 13));			returnData.setApprovalstatus( resultSet.getString( 14));			returnData.setApprovalfeedback( resultSet.getString( 15));			returnData.setInvoicenumber( resultSet.getString( 16));			returnData.setFinishuser( resultSet.getString( 17));			returnData.setFinishdate( resultSet.getString( 18));			returnData.setFinishstatus( resultSet.getString( 19));			returnData.setSupplierid( resultSet.getString( 20));			returnData.setContractids( resultSet.getString( 21));			returnData.setDeptguid( resultSet.getString( 22));			returnData.setCreatetime( resultSet.getString( 23));			returnData.setCreateperson( resultSet.getString( 24));			returnData.setCreateunitid( resultSet.getString( 25));			returnData.setModifytime( resultSet.getString( 26));			returnData.setModifyperson( resultSet.getString( 27));			returnData.setDeleteflag( resultSet.getString( 28));			returnData.setFormid( resultSet.getString( 29));
			return returnData;
		}
		catch(Exception e)
		{
			throw new Exception("Error executing SQL SELECT recordid,paymentid,parentid,subid,requestdate,applicant,deptid,paymentterms,paymentmethod,currency,totalpayable,approvaluser,approvaldate,approvalstatus,approvalfeedback,invoicenumber,finishuser,finishdate,finishstatus,supplierid,contractids,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Payment  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,paymentid,parentid,subid,requestdate,applicant,deptid,paymentterms,paymentmethod,currency,totalpayable,approvaluser,approvaldate,approvalstatus,approvalfeedback,invoicenumber,finishuser,finishdate,finishstatus,supplierid,contractids,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Payment"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,paymentid,parentid,subid,requestdate,applicant,deptid,paymentterms,paymentmethod,currency,totalpayable,approvaluser,approvaldate,approvalstatus,approvalfeedback,invoicenumber,finishuser,finishdate,finishstatus,supplierid,contractids,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Payment" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_Payment SET recordid= ? , paymentid= ? , parentid= ? , subid= ? , requestdate= ? , applicant= ? , deptid= ? , paymentterms= ? , paymentmethod= ? , currency= ? , totalpayable= ? , approvaluser= ? , approvaldate= ? , approvalstatus= ? , approvalfeedback= ? , invoicenumber= ? , finishuser= ? , finishdate= ? , finishstatus= ? , supplierid= ? , contractids= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getPaymentid());			statement.setString( 3,beanData.getParentid());			statement.setString( 4,beanData.getSubid());			if (beanData.getRequestdate()==null || beanData.getRequestdate().trim().equals(""))			{				statement.setNull( 5, Types.DATE);			}			else			{				statement.setString( 5, beanData.getRequestdate());			}			statement.setString( 6,beanData.getApplicant());			statement.setString( 7,beanData.getDeptid());			statement.setString( 8,beanData.getPaymentterms());			statement.setString( 9,beanData.getPaymentmethod());			statement.setString( 10,beanData.getCurrency());			statement.setString( 11,beanData.getTotalpayable());			statement.setString( 12,beanData.getApprovaluser());			if (beanData.getApprovaldate()==null || beanData.getApprovaldate().trim().equals(""))			{				statement.setNull( 13, Types.DATE);			}			else			{				statement.setString( 13, beanData.getApprovaldate());			}			statement.setString( 14,beanData.getApprovalstatus());			statement.setString( 15,beanData.getApprovalfeedback());			statement.setString( 16,beanData.getInvoicenumber());			statement.setString( 17,beanData.getFinishuser());			if (beanData.getFinishdate()==null || beanData.getFinishdate().trim().equals(""))			{				statement.setNull( 18, Types.DATE);			}			else			{				statement.setString( 18, beanData.getFinishdate());			}			statement.setString( 19,beanData.getFinishstatus());			statement.setString( 20,beanData.getSupplierid());			statement.setString( 21,beanData.getContractids());			statement.setString( 22,beanData.getDeptguid());			statement.setString( 23,beanData.getCreatetime());			statement.setString( 24,beanData.getCreateperson());			statement.setString( 25,beanData.getCreateunitid());			statement.setString( 26,beanData.getModifytime());			statement.setString( 27,beanData.getModifyperson());			statement.setString( 28,beanData.getDeleteflag());			statement.setString( 29,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_Payment SET recordid= ? , paymentid= ? , parentid= ? , subid= ? , requestdate= ? , applicant= ? , deptid= ? , paymentterms= ? , paymentmethod= ? , currency= ? , totalpayable= ? , approvaluser= ? , approvaldate= ? , approvalstatus= ? , approvalfeedback= ? , invoicenumber= ? , finishuser= ? , finishdate= ? , finishstatus= ? , supplierid= ? , contractids= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
