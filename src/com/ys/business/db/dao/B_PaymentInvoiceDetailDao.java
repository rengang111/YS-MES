...
* @version 1.0
*/
public class B_PaymentInvoiceDetailDao extends BaseAbstractDao
{
	public B_PaymentInvoiceDetailData beanData=new B_PaymentInvoiceDetailData();
	public B_PaymentInvoiceDetailDao()
	{
	}
	public B_PaymentInvoiceDetailDao(Object beanData) throws Exception
	{
		try
		{
			this.beanData = (B_PaymentInvoiceDetailData)FindByPrimaryKey(beanData);
		}
		catch(Exception e)
		{
	...
	{
		B_PaymentInvoiceDetailData beanData = (B_PaymentInvoiceDetailData) beanDataTmp; 
	...
	public void Remove(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("DELETE FROM B_PaymentInvoiceDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			if (statement.executeUpdate() < 1)
		...
		{
			throw new Exception("Error executing SQL DELETE FROM B_PaymentInvoiceDetail: "+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public String getDeleteSQL(Object beanDataTmp) 
	{
		...
		try
		{
			bufSQL.append("DELETE FROM B_PaymentInvoiceDetail WHERE ");
	...
	public void RemoveByWhere(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("DELETE FROM B_PaymentInvoiceDetail"+ str_Where);
			if (statement.executeUpdate() < 1)
				throw new Exception("Error deleting row");
		}
		catch(Exception e)
	...
	{
		B_PaymentInvoiceDetailData beanData = (B_PaymentInvoiceDetailData)data;
		Connection connection = null;
		PreparedStatement statement = null;
		try
		{
	...
	public void FindPrimaryKey(Object beanDataTmp) throws Exception
	{
		...
		B_PaymentInvoiceDetailData beanData = (B_PaymentInvoiceDetailData) beanDataTmp; 
			connection = getConnection();
			statement = connection.prepareStatement("SELECT  recordid  FROM B_PaymentInvoiceDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			ResultSet resultSet = statement.executeQuery();
			if (!resultSet.next())
			{
		...
		{
			throw new Exception("Error executing SQL  SELECT  recordid  FROM B_PaymentInvoiceDetail WHERE  recordid =?");
		}
		finally
		{
			closeConnection(connection, statement);
