...
* @version 1.0
*/
public class B_PriceSupplierHistoryDao extends BaseAbstractDao
{
	public B_PriceSupplierHistoryData beanData=new B_PriceSupplierHistoryData();
	public B_PriceSupplierHistoryDao()
	{
	}
	public B_PriceSupplierHistoryDao(Object beanData) throws Exception
	{
		try
		{
			this.beanData = (B_PriceSupplierHistoryData)FindByPrimaryKey(beanData);
		}
		catch(Exception e)
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_PriceSupplierHistory( recordid,materialid,supplierid,pricedate,currency,priceunit,price,lastprice,usedflag,pricesource,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public void Remove(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("DELETE FROM B_PriceSupplierHistory WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			if (statement.executeUpdate() < 1)
		...
		{
			throw new Exception("Error executing SQL DELETE FROM B_PriceSupplierHistory: "+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public String getDeleteSQL(Object beanDataTmp) 
	{
		...
		try
		{
			bufSQL.append("DELETE FROM B_PriceSupplierHistory WHERE ");
	...
	public void RemoveByWhere(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("DELETE FROM B_PriceSupplierHistory"+ str_Where);
			if (statement.executeUpdate() < 1)
				throw new Exception("Error deleting row");
		}
		catch(Exception e)
	...
	{
		B_PriceSupplierHistoryData beanData = (B_PriceSupplierHistoryData) beanDataTmp; 
		B_PriceSupplierHistoryData returnData=new B_PriceSupplierHistoryData();
		Connection connection = null;
		PreparedStatement statement = null;
		try
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,materialid,supplierid,pricedate,currency,priceunit,price,lastprice,usedflag,pricesource,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PriceSupplierHistory WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,materialid,supplierid,pricedate,currency,priceunit,price,lastprice,usedflag,pricesource,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PriceSupplierHistory  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,materialid,supplierid,pricedate,currency,priceunit,price,lastprice,usedflag,pricesource,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PriceSupplierHistory"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,materialid,supplierid,pricedate,currency,priceunit,price,lastprice,usedflag,pricesource,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PriceSupplierHistory" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_PriceSupplierHistory SET recordid= ? , materialid= ? , supplierid= ? , pricedate= ? , currency= ? , priceunit= ? , price= ? , lastprice= ? , usedflag= ? , pricesource= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getMaterialid());			statement.setString( 3,beanData.getSupplierid());			if (beanData.getPricedate()==null || beanData.getPricedate().trim().equals(""))			{				statement.setNull( 4, Types.DATE);			}			else			{				statement.setString( 4, beanData.getPricedate());			}			statement.setString( 5,beanData.getCurrency());			statement.setString( 6,beanData.getPriceunit());			statement.setString( 7,beanData.getPrice());			statement.setString( 8,beanData.getLastprice());			statement.setString( 9,beanData.getUsedflag());			statement.setString( 10,beanData.getPricesource());			statement.setString( 11,beanData.getDeptguid());			statement.setString( 12,beanData.getCreatetime());			statement.setString( 13,beanData.getCreateperson());			statement.setString( 14,beanData.getCreateunitid());			statement.setString( 15,beanData.getModifytime());			statement.setString( 16,beanData.getModifyperson());			statement.setString( 17,beanData.getDeleteflag());			statement.setString( 18,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_PriceSupplierHistory SET recordid= ? , materialid= ? , supplierid= ? , pricedate= ? , currency= ? , priceunit= ? , price= ? , lastprice= ? , usedflag= ? , pricesource= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public String getUpdateSQL()
	{
		...
		try
		{
			bufSQL.append("UPDATE B_PriceSupplierHistory SET ");
	...
	{
		B_PriceSupplierHistoryData beanData = (B_PriceSupplierHistoryData)data;
		Connection connection = null;
		PreparedStatement statement = null;
		try
		{
	...
	public void FindPrimaryKey(Object beanDataTmp) throws Exception
	{
		...
		B_PriceSupplierHistoryData beanData = (B_PriceSupplierHistoryData) beanDataTmp; 
			connection = getConnection();
			statement = connection.prepareStatement("SELECT  recordid  FROM B_PriceSupplierHistory WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			ResultSet resultSet = statement.executeQuery();
			if (!resultSet.next())
			{
		...
		{
			throw new Exception("Error executing SQL  SELECT  recordid  FROM B_PriceSupplierHistory WHERE  recordid =?");
		}
		finally
		{
			closeConnection(connection, statement);
