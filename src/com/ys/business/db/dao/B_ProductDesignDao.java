...
public class B_ProductDesignDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_ProductDesign( recordid,productdetailid,subid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		...
		{
			throw new Exception("INSERT INTO B_ProductDesign( recordid,productdetailid,subid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_ProductDesign( recordid,productdetailid,subid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,productdetailid,subid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_ProductDesign WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,productdetailid,subid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_ProductDesign  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,productdetailid,subid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_ProductDesign"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,productdetailid,subid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,status,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_ProductDesign" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_ProductDesign SET recordid= ? , productdetailid= ? , subid= ? , ysid= ? , productid= ? , sealedsample= ? , batterypack= ? , chargertype= ? , packagedescription= ? , storagedescription= ? , status= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getProductdetailid());			statement.setString( 3,beanData.getSubid());			statement.setString( 4,beanData.getYsid());			statement.setString( 5,beanData.getProductid());			statement.setString( 6,beanData.getSealedsample());			statement.setString( 7,beanData.getBatterypack());			statement.setString( 8,beanData.getChargertype());			statement.setString( 9,beanData.getPackagedescription());			statement.setString( 10,beanData.getStoragedescription());			statement.setString( 11,beanData.getStatus());			statement.setString( 12,beanData.getDeptguid());			statement.setString( 13,beanData.getCreatetime());			statement.setString( 14,beanData.getCreateperson());			statement.setString( 15,beanData.getCreateunitid());			statement.setString( 16,beanData.getModifytime());			statement.setString( 17,beanData.getModifyperson());			statement.setString( 18,beanData.getDeleteflag());
		...
		{
			throw new Exception("UPDATE B_ProductDesign SET recordid= ? , productdetailid= ? , subid= ? , ysid= ? , productid= ? , sealedsample= ? , batterypack= ? , chargertype= ? , packagedescription= ? , storagedescription= ? , status= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
