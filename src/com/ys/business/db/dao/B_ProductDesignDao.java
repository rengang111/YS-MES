...
public class B_ProductDesignDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_ProductDesign( recordid,productdetailid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,image_filename,image_filename2,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getProductdetailid());			statement.setString( 3,beanData.getYsid());			statement.setString( 4,beanData.getProductid());			statement.setString( 5,beanData.getSealedsample());			statement.setString( 6,beanData.getBatterypack());			statement.setString( 7,beanData.getChargertype());			statement.setString( 8,beanData.getPackagedescription());			statement.setString( 9,beanData.getStoragedescription());			statement.setString( 10,beanData.getImage_filename());			statement.setString( 11,beanData.getImage_filename2());			statement.setString( 12,beanData.getDeptguid());			statement.setString( 13,beanData.getCreatetime());			statement.setString( 14,beanData.getCreateperson());			statement.setString( 15,beanData.getCreateunitid());			statement.setString( 16,beanData.getModifytime());			statement.setString( 17,beanData.getModifyperson());			statement.setString( 18,beanData.getDeleteflag());
		...
		{
			throw new Exception("INSERT INTO B_ProductDesign( recordid,productdetailid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,image_filename,image_filename2,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_ProductDesign( recordid,productdetailid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,image_filename,image_filename2,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,productdetailid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,image_filename,image_filename2,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_ProductDesign WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			...
			returnData.setRecordid( resultSet.getString( 1));			returnData.setProductdetailid( resultSet.getString( 2));			returnData.setYsid( resultSet.getString( 3));			returnData.setProductid( resultSet.getString( 4));			returnData.setSealedsample( resultSet.getString( 5));			returnData.setBatterypack( resultSet.getString( 6));			returnData.setChargertype( resultSet.getString( 7));			returnData.setPackagedescription( resultSet.getString( 8));			returnData.setStoragedescription( resultSet.getString( 9));			returnData.setImage_filename( resultSet.getString( 10));			returnData.setImage_filename2( resultSet.getString( 11));			returnData.setDeptguid( resultSet.getString( 12));			returnData.setCreatetime( resultSet.getString( 13));			returnData.setCreateperson( resultSet.getString( 14));			returnData.setCreateunitid( resultSet.getString( 15));			returnData.setModifytime( resultSet.getString( 16));			returnData.setModifyperson( resultSet.getString( 17));			returnData.setDeleteflag( resultSet.getString( 18));
			return returnData;
		}
		catch(Exception e)
		{
			throw new Exception("Error executing SQL SELECT recordid,productdetailid,ysid,productid,sealedsample,batterypack,chargertype,packagedescription,storagedescription,image_filename,image_filename2,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_ProductDesign  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_ProductDesign SET recordid= ? , productdetailid= ? , ysid= ? , productid= ? , sealedsample= ? , batterypack= ? , chargertype= ? , packagedescription= ? , storagedescription= ? , image_filename= ? , image_filename2= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getProductdetailid());			statement.setString( 3,beanData.getYsid());			statement.setString( 4,beanData.getProductid());			statement.setString( 5,beanData.getSealedsample());			statement.setString( 6,beanData.getBatterypack());			statement.setString( 7,beanData.getChargertype());			statement.setString( 8,beanData.getPackagedescription());			statement.setString( 9,beanData.getStoragedescription());			statement.setString( 10,beanData.getImage_filename());			statement.setString( 11,beanData.getImage_filename2());			statement.setString( 12,beanData.getDeptguid());			statement.setString( 13,beanData.getCreatetime());			statement.setString( 14,beanData.getCreateperson());			statement.setString( 15,beanData.getCreateunitid());			statement.setString( 16,beanData.getModifytime());			statement.setString( 17,beanData.getModifyperson());			statement.setString( 18,beanData.getDeleteflag());
		...
		{
			throw new Exception("UPDATE B_ProductDesign SET recordid= ? , productdetailid= ? , ysid= ? , productid= ? , sealedsample= ? , batterypack= ? , chargertype= ? , packagedescription= ? , storagedescription= ? , image_filename= ? , image_filename2= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
