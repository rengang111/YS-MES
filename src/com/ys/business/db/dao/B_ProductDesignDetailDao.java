...
public class B_ProductDesignDetailDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_ProductDesignDetail( recordid,productdetailid,type,componentname,materialid,purchaser,materialquality,color,specification,process,size,packingqty,filename,remark,sortno,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getProductdetailid());			statement.setString( 3,beanData.getType());			statement.setString( 4,beanData.getComponentname());			statement.setString( 5,beanData.getMaterialid());			statement.setString( 6,beanData.getPurchaser());			statement.setString( 7,beanData.getMaterialquality());			statement.setString( 8,beanData.getColor());			statement.setString( 9,beanData.getSpecification());			statement.setString( 10,beanData.getProcess());			statement.setString( 11,beanData.getSize());			statement.setString( 12,beanData.getPackingqty());			statement.setString( 13,beanData.getFilename());			statement.setString( 14,beanData.getRemark());			statement.setString( 15,beanData.getSortno());			statement.setString( 16,beanData.getDeptguid());			statement.setString( 17,beanData.getCreatetime());			statement.setString( 18,beanData.getCreateperson());			statement.setString( 19,beanData.getCreateunitid());			statement.setString( 20,beanData.getModifytime());			statement.setString( 21,beanData.getModifyperson());			statement.setString( 22,beanData.getDeleteflag());
		...
		{
			throw new Exception("INSERT INTO B_ProductDesignDetail( recordid,productdetailid,type,componentname,materialid,purchaser,materialquality,color,specification,process,size,packingqty,filename,remark,sortno,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_ProductDesignDetail( recordid,productdetailid,type,componentname,materialid,purchaser,materialquality,color,specification,process,size,packingqty,filename,remark,sortno,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,productdetailid,type,componentname,materialid,purchaser,materialquality,color,specification,process,size,packingqty,filename,remark,sortno,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_ProductDesignDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			...
			returnData.setRecordid( resultSet.getString( 1));			returnData.setProductdetailid( resultSet.getString( 2));			returnData.setType( resultSet.getString( 3));			returnData.setComponentname( resultSet.getString( 4));			returnData.setMaterialid( resultSet.getString( 5));			returnData.setPurchaser( resultSet.getString( 6));			returnData.setMaterialquality( resultSet.getString( 7));			returnData.setColor( resultSet.getString( 8));			returnData.setSpecification( resultSet.getString( 9));			returnData.setProcess( resultSet.getString( 10));			returnData.setSize( resultSet.getString( 11));			returnData.setPackingqty( resultSet.getString( 12));			returnData.setFilename( resultSet.getString( 13));			returnData.setRemark( resultSet.getString( 14));			returnData.setSortno( resultSet.getString( 15));			returnData.setDeptguid( resultSet.getString( 16));			returnData.setCreatetime( resultSet.getString( 17));			returnData.setCreateperson( resultSet.getString( 18));			returnData.setCreateunitid( resultSet.getString( 19));			returnData.setModifytime( resultSet.getString( 20));			returnData.setModifyperson( resultSet.getString( 21));			returnData.setDeleteflag( resultSet.getString( 22));
			return returnData;
		}
		catch(Exception e)
		{
			throw new Exception("Error executing SQL SELECT recordid,productdetailid,type,componentname,materialid,purchaser,materialquality,color,specification,process,size,packingqty,filename,remark,sortno,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag FROM B_ProductDesignDetail  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_ProductDesignDetail SET recordid= ? , productdetailid= ? , type= ? , componentname= ? , materialid= ? , purchaser= ? , materialquality= ? , color= ? , specification= ? , process= ? , size= ? , packingqty= ? , filename= ? , remark= ? , sortno= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getProductdetailid());			statement.setString( 3,beanData.getType());			statement.setString( 4,beanData.getComponentname());			statement.setString( 5,beanData.getMaterialid());			statement.setString( 6,beanData.getPurchaser());			statement.setString( 7,beanData.getMaterialquality());			statement.setString( 8,beanData.getColor());			statement.setString( 9,beanData.getSpecification());			statement.setString( 10,beanData.getProcess());			statement.setString( 11,beanData.getSize());			statement.setString( 12,beanData.getPackingqty());			statement.setString( 13,beanData.getFilename());			statement.setString( 14,beanData.getRemark());			statement.setString( 15,beanData.getSortno());			statement.setString( 16,beanData.getDeptguid());			statement.setString( 17,beanData.getCreatetime());			statement.setString( 18,beanData.getCreateperson());			statement.setString( 19,beanData.getCreateunitid());			statement.setString( 20,beanData.getModifytime());			statement.setString( 21,beanData.getModifyperson());			statement.setString( 22,beanData.getDeleteflag());
		...
		{
			throw new Exception("UPDATE B_ProductDesignDetail SET recordid= ? , productdetailid= ? , type= ? , componentname= ? , materialid= ? , purchaser= ? , materialquality= ? , color= ? , specification= ? , process= ? , size= ? , packingqty= ? , filename= ? , remark= ? , sortno= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
