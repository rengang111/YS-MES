...
public class B_PurchaseOrderDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_PurchaseOrder( recordid,ysid,materialid,supplierid,contractid,typeparentid,typeserial,supplierparentid,supplierserial,total,taxexcluded,taxes,taxrate,purchasedate,deliverydate,memo,stockindate,status,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,ysid,materialid,supplierid,contractid,typeparentid,typeserial,supplierparentid,supplierserial,total,taxexcluded,taxes,taxrate,purchasedate,deliverydate,memo,stockindate,status,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseOrder WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,ysid,materialid,supplierid,contractid,typeparentid,typeserial,supplierparentid,supplierserial,total,taxexcluded,taxes,taxrate,purchasedate,deliverydate,memo,stockindate,status,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseOrder"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,ysid,materialid,supplierid,contractid,typeparentid,typeserial,supplierparentid,supplierserial,total,taxexcluded,taxes,taxrate,purchasedate,deliverydate,memo,stockindate,status,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseOrder" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_PurchaseOrder SET recordid= ? , ysid= ? , materialid= ? , supplierid= ? , contractid= ? , typeparentid= ? , typeserial= ? , supplierparentid= ? , supplierserial= ? , total= ? , taxexcluded= ? , taxes= ? , taxrate= ? , purchasedate= ? , deliverydate= ? , memo= ? , stockindate= ? , status= ? , version= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getYsid());			statement.setString( 3,beanData.getMaterialid());			statement.setString( 4,beanData.getSupplierid());			statement.setString( 5,beanData.getContractid());			statement.setString( 6,beanData.getTypeparentid());			statement.setString( 7,beanData.getTypeserial());			statement.setString( 8,beanData.getSupplierparentid());			statement.setString( 9,beanData.getSupplierserial());			statement.setString( 10,beanData.getTotal());			statement.setString( 11,beanData.getTaxexcluded());			statement.setString( 12,beanData.getTaxes());			statement.setString( 13,beanData.getTaxrate());			if (beanData.getPurchasedate()==null || beanData.getPurchasedate().trim().equals(""))			{				statement.setNull( 14, Types.DATE);			}			else			{				statement.setString( 14, beanData.getPurchasedate());			}			if (beanData.getDeliverydate()==null || beanData.getDeliverydate().trim().equals(""))			{				statement.setNull( 15, Types.DATE);			}			else			{				statement.setString( 15, beanData.getDeliverydate());			}			statement.setString( 16,beanData.getMemo());			if (beanData.getStockindate()==null || beanData.getStockindate().trim().equals(""))			{				statement.setNull( 17, Types.DATE);			}			else			{				statement.setString( 17, beanData.getStockindate());			}			statement.setString( 18,beanData.getStatus());			statement.setInt( 19,beanData.getVersion());			statement.setString( 20,beanData.getDeptguid());			statement.setString( 21,beanData.getCreatetime());			statement.setString( 22,beanData.getCreateperson());			statement.setString( 23,beanData.getCreateunitid());			statement.setString( 24,beanData.getModifytime());			statement.setString( 25,beanData.getModifyperson());			statement.setString( 26,beanData.getDeleteflag());			statement.setString( 27,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_PurchaseOrder SET recordid= ? , ysid= ? , materialid= ? , supplierid= ? , contractid= ? , typeparentid= ? , typeserial= ? , supplierparentid= ? , supplierserial= ? , total= ? , taxexcluded= ? , taxes= ? , taxrate= ? , purchasedate= ? , deliverydate= ? , memo= ? , stockindate= ? , status= ? , version= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
