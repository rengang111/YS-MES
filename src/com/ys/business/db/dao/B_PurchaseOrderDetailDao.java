...
public class B_PurchaseOrderDetailDao extends BaseAbstractDao
{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_PurchaseOrderDetail( recordid,ysid,contractid,materialid,description,unitquantity,quantity,accumulated,contractstorage,returngoods,returnnumber,price,totalprice,status,version,newdeliverydate,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,ysid,contractid,materialid,description,unitquantity,quantity,accumulated,contractstorage,returngoods,returnnumber,price,totalprice,status,version,newdeliverydate,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseOrderDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,ysid,contractid,materialid,description,unitquantity,quantity,accumulated,contractstorage,returngoods,returnnumber,price,totalprice,status,version,newdeliverydate,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseOrderDetail"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,ysid,contractid,materialid,description,unitquantity,quantity,accumulated,contractstorage,returngoods,returnnumber,price,totalprice,status,version,newdeliverydate,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseOrderDetail" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
