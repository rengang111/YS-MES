...
public class B_PurchaseOrderDetailDao extends BaseAbstractDao
{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_PurchaseOrderDetail( recordid,ysid,contractid,materialid,unitquantity,quantity,accumulated,contractstorage,returngoods,returnnumber,price,totalprice,status,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
