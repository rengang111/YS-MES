...
public class B_PurchaseOrderDetailDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_PurchaseOrderDetail( recordid,ysid,contractid,materialid,description,unitquantity,quantity,accumulated,contractstorage,returngoods,returnnumber,price,totalprice,status,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,ysid,contractid,materialid,description,unitquantity,quantity,accumulated,contractstorage,returngoods,returnnumber,price,totalprice,status,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseOrderDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,ysid,contractid,materialid,description,unitquantity,quantity,accumulated,contractstorage,returngoods,returnnumber,price,totalprice,status,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseOrderDetail"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,ysid,contractid,materialid,description,unitquantity,quantity,accumulated,contractstorage,returngoods,returnnumber,price,totalprice,status,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseOrderDetail" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_PurchaseOrderDetail SET recordid= ? , ysid= ? , contractid= ? , materialid= ? , description= ? , unitquantity= ? , quantity= ? , accumulated= ? , contractstorage= ? , returngoods= ? , returnnumber= ? , price= ? , totalprice= ? , status= ? , version= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getYsid());			statement.setString( 3,beanData.getContractid());			statement.setString( 4,beanData.getMaterialid());			statement.setString( 5,beanData.getDescription());			statement.setString( 6,beanData.getUnitquantity());			statement.setString( 7,beanData.getQuantity());			statement.setString( 8,beanData.getAccumulated());			statement.setString( 9,beanData.getContractstorage());			statement.setString( 10,beanData.getReturngoods());			statement.setString( 11,beanData.getReturnnumber());			statement.setString( 12,beanData.getPrice());			statement.setString( 13,beanData.getTotalprice());			statement.setString( 14,beanData.getStatus());			statement.setInt( 15,beanData.getVersion());			statement.setString( 16,beanData.getDeptguid());			statement.setString( 17,beanData.getCreatetime());			statement.setString( 18,beanData.getCreateperson());			statement.setString( 19,beanData.getCreateunitid());			statement.setString( 20,beanData.getModifytime());			statement.setString( 21,beanData.getModifyperson());			statement.setString( 22,beanData.getDeleteflag());			statement.setString( 23,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_PurchaseOrderDetail SET recordid= ? , ysid= ? , contractid= ? , materialid= ? , description= ? , unitquantity= ? , quantity= ? , accumulated= ? , contractstorage= ? , returngoods= ? , returnnumber= ? , price= ? , totalprice= ? , status= ? , version= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
