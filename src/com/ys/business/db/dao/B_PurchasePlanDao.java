...
public class B_PurchasePlanDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_PurchasePlan( recordid,purchaseid,ysid,subid,materialid,supplierid,price,oldsupplierid,oldprice,pricestatus,orderquantity,quantity,totalprice,subbomid,remark,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_PurchasePlan( recordid,purchaseid,ysid,subid,materialid,supplierid,price,oldsupplierid,oldprice,pricestatus,orderquantity,quantity,totalprice,subbomid,remark,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_PurchasePlan SET recordid= ? , purchaseid= ? , ysid= ? , subid= ? , materialid= ? , supplierid= ? , price= ? , oldsupplierid= ? , oldprice= ? , pricestatus= ? , orderquantity= ? , quantity= ? , totalprice= ? , subbomid= ? , remark= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getPurchaseid());			statement.setString( 3,beanData.getYsid());			statement.setString( 4,beanData.getSubid());			statement.setString( 5,beanData.getMaterialid());			statement.setString( 6,beanData.getSupplierid());			statement.setString( 7,beanData.getPrice());			statement.setString( 8,beanData.getOldsupplierid());			statement.setString( 9,beanData.getOldprice());			statement.setString( 10,beanData.getPricestatus());			statement.setString( 11,beanData.getOrderquantity());			statement.setString( 12,beanData.getQuantity());			statement.setString( 13,beanData.getTotalprice());			statement.setString( 14,beanData.getSubbomid());			statement.setString( 15,beanData.getRemark());			statement.setString( 16,beanData.getDeptguid());			statement.setString( 17,beanData.getCreatetime());			statement.setString( 18,beanData.getCreateperson());			statement.setString( 19,beanData.getCreateunitid());			statement.setString( 20,beanData.getModifytime());			statement.setString( 21,beanData.getModifyperson());			statement.setString( 22,beanData.getDeleteflag());			statement.setString( 23,beanData.getFormid());
