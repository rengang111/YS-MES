...
public class B_PurchasePlanDetailDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_PurchasePlanDetail( recordid,purchaseid,ysid,subid,materialid,purchasetype,unitquantity,supplierid,suppliershortname,price,pricestatus,manufacturequantity,purchasequantity,requisitiontype,totalrequisition,totalprice,subbomno,version,contractflag,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getPurchaseid());			statement.setString( 3,beanData.getYsid());			statement.setString( 4,beanData.getSubid());			statement.setString( 5,beanData.getMaterialid());			statement.setString( 6,beanData.getPurchasetype());			statement.setString( 7,beanData.getUnitquantity());			statement.setString( 8,beanData.getSupplierid());			statement.setString( 9,beanData.getSuppliershortname());			statement.setString( 10,beanData.getPrice());			statement.setString( 11,beanData.getPricestatus());			statement.setString( 12,beanData.getManufacturequantity());			statement.setString( 13,beanData.getPurchasequantity());			statement.setString( 14,beanData.getRequisitiontype());			statement.setString( 15,beanData.getTotalrequisition());			statement.setString( 16,beanData.getTotalprice());			statement.setString( 17,beanData.getSubbomno());			statement.setInt( 18,beanData.getVersion());			statement.setInt( 19,beanData.getContractflag());			statement.setString( 20,beanData.getDeptguid());			statement.setString( 21,beanData.getCreatetime());			statement.setString( 22,beanData.getCreateperson());			statement.setString( 23,beanData.getCreateunitid());			statement.setString( 24,beanData.getModifytime());			statement.setString( 25,beanData.getModifyperson());			statement.setString( 26,beanData.getDeleteflag());			statement.setString( 27,beanData.getFormid());
		...
		{
			throw new Exception("INSERT INTO B_PurchasePlanDetail( recordid,purchaseid,ysid,subid,materialid,purchasetype,unitquantity,supplierid,suppliershortname,price,pricestatus,manufacturequantity,purchasequantity,requisitiontype,totalrequisition,totalprice,subbomno,version,contractflag,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,purchaseid,ysid,subid,materialid,purchasetype,unitquantity,supplierid,suppliershortname,price,pricestatus,manufacturequantity,purchasequantity,requisitiontype,totalrequisition,totalprice,subbomno,version,contractflag,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchasePlanDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			...
			returnData.setRecordid( resultSet.getString( 1));			returnData.setPurchaseid( resultSet.getString( 2));			returnData.setYsid( resultSet.getString( 3));			returnData.setSubid( resultSet.getString( 4));			returnData.setMaterialid( resultSet.getString( 5));			returnData.setPurchasetype( resultSet.getString( 6));			returnData.setUnitquantity( resultSet.getString( 7));			returnData.setSupplierid( resultSet.getString( 8));			returnData.setSuppliershortname( resultSet.getString( 9));			returnData.setPrice( resultSet.getString( 10));			returnData.setPricestatus( resultSet.getString( 11));			returnData.setManufacturequantity( resultSet.getString( 12));			returnData.setPurchasequantity( resultSet.getString( 13));			returnData.setRequisitiontype( resultSet.getString( 14));			returnData.setTotalrequisition( resultSet.getString( 15));			returnData.setTotalprice( resultSet.getString( 16));			returnData.setSubbomno( resultSet.getString( 17));			returnData.setVersion( resultSet.getInt( 18));			returnData.setContractflag( resultSet.getInt( 19));			returnData.setDeptguid( resultSet.getString( 20));			returnData.setCreatetime( resultSet.getString( 21));			returnData.setCreateperson( resultSet.getString( 22));			returnData.setCreateunitid( resultSet.getString( 23));			returnData.setModifytime( resultSet.getString( 24));			returnData.setModifyperson( resultSet.getString( 25));			returnData.setDeleteflag( resultSet.getString( 26));			returnData.setFormid( resultSet.getString( 27));
			return returnData;
		}
		catch(Exception e)
		{
			throw new Exception("Error executing SQL SELECT recordid,purchaseid,ysid,subid,materialid,purchasetype,unitquantity,supplierid,suppliershortname,price,pricestatus,manufacturequantity,purchasequantity,requisitiontype,totalrequisition,totalprice,subbomno,version,contractflag,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchasePlanDetail  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_PurchasePlanDetail SET recordid= ? , purchaseid= ? , ysid= ? , subid= ? , materialid= ? , purchasetype= ? , unitquantity= ? , supplierid= ? , suppliershortname= ? , price= ? , pricestatus= ? , manufacturequantity= ? , purchasequantity= ? , requisitiontype= ? , totalrequisition= ? , totalprice= ? , subbomno= ? , version= ? , contractflag= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getPurchaseid());			statement.setString( 3,beanData.getYsid());			statement.setString( 4,beanData.getSubid());			statement.setString( 5,beanData.getMaterialid());			statement.setString( 6,beanData.getPurchasetype());			statement.setString( 7,beanData.getUnitquantity());			statement.setString( 8,beanData.getSupplierid());			statement.setString( 9,beanData.getSuppliershortname());			statement.setString( 10,beanData.getPrice());			statement.setString( 11,beanData.getPricestatus());			statement.setString( 12,beanData.getManufacturequantity());			statement.setString( 13,beanData.getPurchasequantity());			statement.setString( 14,beanData.getRequisitiontype());			statement.setString( 15,beanData.getTotalrequisition());			statement.setString( 16,beanData.getTotalprice());			statement.setString( 17,beanData.getSubbomno());			statement.setInt( 18,beanData.getVersion());			statement.setInt( 19,beanData.getContractflag());			statement.setString( 20,beanData.getDeptguid());			statement.setString( 21,beanData.getCreatetime());			statement.setString( 22,beanData.getCreateperson());			statement.setString( 23,beanData.getCreateunitid());			statement.setString( 24,beanData.getModifytime());			statement.setString( 25,beanData.getModifyperson());			statement.setString( 26,beanData.getDeleteflag());			statement.setString( 27,beanData.getFormid());
			statement.setString( 28,beanData.getRecordid());
			if (statement.executeUpdate() < 1)
				throw new Exception(" Row Not does; ");
		}
		catch(Exception e)
		{
			throw new Exception("UPDATE B_PurchasePlanDetail SET recordid= ? , purchaseid= ? , ysid= ? , subid= ? , materialid= ? , purchasetype= ? , unitquantity= ? , supplierid= ? , suppliershortname= ? , price= ? , pricestatus= ? , manufacturequantity= ? , purchasequantity= ? , requisitiontype= ? , totalrequisition= ? , totalprice= ? , subbomno= ? , version= ? , contractflag= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
