...
public class B_PurchasePlanDetailDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_PurchasePlanDetail( recordid,purchaseid,ysid,subid,materialid,purchasetype,unitquantity,supplierid,suppliershortname,price,pricestatus,manufacturequantity,purchasequantity,totalrequisition,totalprice,subbomno,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		...
		{
			throw new Exception("INSERT INTO B_PurchasePlanDetail( recordid,purchaseid,ysid,subid,materialid,purchasetype,unitquantity,supplierid,suppliershortname,price,pricestatus,manufacturequantity,purchasequantity,totalrequisition,totalprice,subbomno,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_PurchasePlanDetail( recordid,purchaseid,ysid,subid,materialid,purchasetype,unitquantity,supplierid,suppliershortname,price,pricestatus,manufacturequantity,purchasequantity,totalrequisition,totalprice,subbomno,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,purchaseid,ysid,subid,materialid,purchasetype,unitquantity,supplierid,suppliershortname,price,pricestatus,manufacturequantity,purchasequantity,totalrequisition,totalprice,subbomno,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchasePlanDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,purchaseid,ysid,subid,materialid,purchasetype,unitquantity,supplierid,suppliershortname,price,pricestatus,manufacturequantity,purchasequantity,totalrequisition,totalprice,subbomno,version,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchasePlanDetail  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_PurchasePlanDetail SET recordid= ? , purchaseid= ? , ysid= ? , subid= ? , materialid= ? , purchasetype= ? , unitquantity= ? , supplierid= ? , suppliershortname= ? , price= ? , pricestatus= ? , manufacturequantity= ? , purchasequantity= ? , totalrequisition= ? , totalprice= ? , subbomno= ? , version= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getPurchaseid());			statement.setString( 3,beanData.getYsid());			statement.setString( 4,beanData.getSubid());			statement.setString( 5,beanData.getMaterialid());			statement.setString( 6,beanData.getPurchasetype());			statement.setString( 7,beanData.getUnitquantity());			statement.setString( 8,beanData.getSupplierid());			statement.setString( 9,beanData.getSuppliershortname());			statement.setString( 10,beanData.getPrice());			statement.setString( 11,beanData.getPricestatus());			statement.setString( 12,beanData.getManufacturequantity());			statement.setString( 13,beanData.getPurchasequantity());			statement.setString( 14,beanData.getTotalrequisition());			statement.setString( 15,beanData.getTotalprice());			statement.setString( 16,beanData.getSubbomno());			statement.setInt( 17,beanData.getVersion());			statement.setString( 18,beanData.getDeptguid());			statement.setString( 19,beanData.getCreatetime());			statement.setString( 20,beanData.getCreateperson());			statement.setString( 21,beanData.getCreateunitid());			statement.setString( 22,beanData.getModifytime());			statement.setString( 23,beanData.getModifyperson());			statement.setString( 24,beanData.getDeleteflag());			statement.setString( 25,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_PurchasePlanDetail SET recordid= ? , purchaseid= ? , ysid= ? , subid= ? , materialid= ? , purchasetype= ? , unitquantity= ? , supplierid= ? , suppliershortname= ? , price= ? , pricestatus= ? , manufacturequantity= ? , purchasequantity= ? , totalrequisition= ? , totalprice= ? , subbomno= ? , version= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
