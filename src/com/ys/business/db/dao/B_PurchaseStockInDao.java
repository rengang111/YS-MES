...
public class B_PurchaseStockInDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_PurchaseStockIn( recordid,receiptid,parentid,subid,ysid,contractid,arrivelid,supplierid,checkindate,keepuser,packagnumber,originalreceiptid,stockintype,remarks,reverse,storagefinish,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		...
		{
			throw new Exception("INSERT INTO B_PurchaseStockIn( recordid,receiptid,parentid,subid,ysid,contractid,arrivelid,supplierid,checkindate,keepuser,packagnumber,originalreceiptid,stockintype,remarks,reverse,storagefinish,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,receiptid,parentid,subid,ysid,contractid,arrivelid,supplierid,checkindate,keepuser,packagnumber,originalreceiptid,stockintype,remarks,reverse,storagefinish,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseStockIn WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,receiptid,parentid,subid,ysid,contractid,arrivelid,supplierid,checkindate,keepuser,packagnumber,originalreceiptid,stockintype,remarks,reverse,storagefinish,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseStockIn  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,receiptid,parentid,subid,ysid,contractid,arrivelid,supplierid,checkindate,keepuser,packagnumber,originalreceiptid,stockintype,remarks,reverse,storagefinish,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseStockIn"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,receiptid,parentid,subid,ysid,contractid,arrivelid,supplierid,checkindate,keepuser,packagnumber,originalreceiptid,stockintype,remarks,reverse,storagefinish,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseStockIn" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_PurchaseStockIn SET recordid= ? , receiptid= ? , parentid= ? , subid= ? , ysid= ? , contractid= ? , arrivelid= ? , supplierid= ? , checkindate= ? , keepuser= ? , packagnumber= ? , originalreceiptid= ? , stockintype= ? , remarks= ? , reverse= ? , storagefinish= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getReceiptid());			statement.setString( 3,beanData.getParentid());			statement.setString( 4,beanData.getSubid());			statement.setString( 5,beanData.getYsid());			statement.setString( 6,beanData.getContractid());			statement.setString( 7,beanData.getArrivelid());			statement.setString( 8,beanData.getSupplierid());			statement.setString( 9,beanData.getCheckindate());			statement.setString( 10,beanData.getKeepuser());			statement.setString( 11,beanData.getPackagnumber());			statement.setString( 12,beanData.getOriginalreceiptid());			statement.setString( 13,beanData.getStockintype());			statement.setString( 14,beanData.getRemarks());			statement.setString( 15,beanData.getReverse());			statement.setString( 16,beanData.getStoragefinish());			statement.setString( 17,beanData.getDeptguid());			statement.setString( 18,beanData.getCreatetime());			statement.setString( 19,beanData.getCreateperson());			statement.setString( 20,beanData.getCreateunitid());			statement.setString( 21,beanData.getModifytime());			statement.setString( 22,beanData.getModifyperson());			statement.setString( 23,beanData.getDeleteflag());			statement.setString( 24,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_PurchaseStockIn SET recordid= ? , receiptid= ? , parentid= ? , subid= ? , ysid= ? , contractid= ? , arrivelid= ? , supplierid= ? , checkindate= ? , keepuser= ? , packagnumber= ? , originalreceiptid= ? , stockintype= ? , remarks= ? , reverse= ? , storagefinish= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
