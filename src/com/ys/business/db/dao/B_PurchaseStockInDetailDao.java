...
public class B_PurchaseStockInDetailDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_PurchaseStockInDetail( recordid,receiptid,materialid,quantity,price,depotid,areanumber,shelfnumber,placenumber,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_PurchaseStockInDetail( recordid,receiptid,materialid,quantity,price,depotid,areanumber,shelfnumber,placenumber,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,receiptid,materialid,quantity,price,depotid,areanumber,shelfnumber,placenumber,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseStockInDetail WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,receiptid,materialid,quantity,price,depotid,areanumber,shelfnumber,placenumber,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseStockInDetail"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,receiptid,materialid,quantity,price,depotid,areanumber,shelfnumber,placenumber,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_PurchaseStockInDetail" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_PurchaseStockInDetail SET recordid= ? , receiptid= ? , materialid= ? , quantity= ? , price= ? , depotid= ? , areanumber= ? , shelfnumber= ? , placenumber= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getReceiptid());			statement.setString( 3,beanData.getMaterialid());			statement.setString( 4,beanData.getQuantity());			statement.setString( 5,beanData.getPrice());			statement.setString( 6,beanData.getDepotid());			statement.setString( 7,beanData.getAreanumber());			statement.setString( 8,beanData.getShelfnumber());			statement.setString( 9,beanData.getPlacenumber());			statement.setString( 10,beanData.getDeptguid());			statement.setString( 11,beanData.getCreatetime());			statement.setString( 12,beanData.getCreateperson());			statement.setString( 13,beanData.getCreateunitid());			statement.setString( 14,beanData.getModifytime());			statement.setString( 15,beanData.getModifyperson());			statement.setString( 16,beanData.getDeleteflag());			statement.setString( 17,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_PurchaseStockInDetail SET recordid= ? , receiptid= ? , materialid= ? , quantity= ? , price= ? , depotid= ? , areanumber= ? , shelfnumber= ? , placenumber= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
