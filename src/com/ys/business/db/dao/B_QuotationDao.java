...
* @version 1.0
*/
public class B_QuotationDao extends BaseAbstractDao
{
	public B_QuotationData beanData=new B_QuotationData();
	public B_QuotationDao()
	{
	}
	public B_QuotationDao(Object beanData) throws Exception
	{
		try
		{
			this.beanData = (B_QuotationData)FindByPrimaryKey(beanData);
		}
		catch(Exception e)
		{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_Quotation( recordid,bomid,materialid,parentid,subid,ysid,bomtype,managementcostrate,managementcost,bomcost,productcost,totalcost,laborcost,materialcost,plandate,currency,exchangerate,exchangeprice,salestax,rebate,rebaterate,rmbprice,discount,commission,profitrate,profit,sourcebomid,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_Quotation( recordid,bomid,materialid,parentid,subid,ysid,bomtype,managementcostrate,managementcost,bomcost,productcost,totalcost,laborcost,materialcost,plandate,currency,exchangerate,exchangeprice,salestax,rebate,rebaterate,rmbprice,discount,commission,profitrate,profit,sourcebomid,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public void Remove(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("DELETE FROM B_Quotation WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			if (statement.executeUpdate() < 1)
		...
		{
			throw new Exception("Error executing SQL DELETE FROM B_Quotation: "+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public String getDeleteSQL(Object beanDataTmp) 
	{
		...
		try
		{
			bufSQL.append("DELETE FROM B_Quotation WHERE ");
	...
	public void RemoveByWhere(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("DELETE FROM B_Quotation"+ str_Where);
			if (statement.executeUpdate() < 1)
				throw new Exception("Error deleting row");
		}
		catch(Exception e)
	...
	{
		B_QuotationData beanData = (B_QuotationData) beanDataTmp; 
		B_QuotationData returnData=new B_QuotationData();
		Connection connection = null;
		PreparedStatement statement = null;
		try
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,bomid,materialid,parentid,subid,ysid,bomtype,managementcostrate,managementcost,bomcost,productcost,totalcost,laborcost,materialcost,plandate,currency,exchangerate,exchangeprice,salestax,rebate,rebaterate,rmbprice,discount,commission,profitrate,profit,sourcebomid,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Quotation WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_Quotation SET recordid= ? , bomid= ? , materialid= ? , parentid= ? , subid= ? , ysid= ? , bomtype= ? , managementcostrate= ? , managementcost= ? , bomcost= ? , productcost= ? , totalcost= ? , laborcost= ? , materialcost= ? , plandate= ? , currency= ? , exchangerate= ? , exchangeprice= ? , salestax= ? , rebate= ? , rebaterate= ? , rmbprice= ? , discount= ? , commission= ? , profitrate= ? , profit= ? , sourcebomid= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getBomid());			statement.setString( 3,beanData.getMaterialid());			statement.setString( 4,beanData.getParentid());			statement.setString( 5,beanData.getSubid());			statement.setString( 6,beanData.getYsid());			statement.setString( 7,beanData.getBomtype());			statement.setString( 8,beanData.getManagementcostrate());			statement.setString( 9,beanData.getManagementcost());			statement.setString( 10,beanData.getBomcost());			statement.setString( 11,beanData.getProductcost());			statement.setString( 12,beanData.getTotalcost());			statement.setString( 13,beanData.getLaborcost());			statement.setString( 14,beanData.getMaterialcost());			if (beanData.getPlandate()==null || beanData.getPlandate().trim().equals(""))			{				statement.setNull( 15, Types.DATE);			}			else			{				statement.setString( 15, beanData.getPlandate());			}			statement.setString( 16,beanData.getCurrency());			statement.setString( 17,beanData.getExchangerate());			statement.setString( 18,beanData.getExchangeprice());			statement.setString( 19,beanData.getSalestax());			statement.setString( 20,beanData.getRebate());			statement.setString( 21,beanData.getRebaterate());			statement.setString( 22,beanData.getRmbprice());			statement.setString( 23,beanData.getDiscount());			statement.setString( 24,beanData.getCommission());			statement.setString( 25,beanData.getProfitrate());			statement.setString( 26,beanData.getProfit());			statement.setString( 27,beanData.getSourcebomid());			statement.setString( 28,beanData.getDeptguid());			statement.setString( 29,beanData.getCreatetime());			statement.setString( 30,beanData.getCreateperson());			statement.setString( 31,beanData.getCreateunitid());			statement.setString( 32,beanData.getModifytime());			statement.setString( 33,beanData.getModifyperson());			statement.setString( 34,beanData.getDeleteflag());			statement.setString( 35,beanData.getFormid());
			statement.setString( 36,beanData.getRecordid());
			if (statement.executeUpdate() < 1)
				throw new Exception(" Row Not does; ");
		}
		catch(Exception e)
		{
			throw new Exception("UPDATE B_Quotation SET recordid= ? , bomid= ? , materialid= ? , parentid= ? , subid= ? , ysid= ? , bomtype= ? , managementcostrate= ? , managementcost= ? , bomcost= ? , productcost= ? , totalcost= ? , laborcost= ? , materialcost= ? , plandate= ? , currency= ? , exchangerate= ? , exchangeprice= ? , salestax= ? , rebate= ? , rebaterate= ? , rmbprice= ? , discount= ? , commission= ? , profitrate= ? , profit= ? , sourcebomid= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public String getUpdateSQL()
	{
		...
		try
		{
			bufSQL.append("UPDATE B_Quotation SET ");
	...
	{
		B_QuotationData beanData = (B_QuotationData)data;
		Connection connection = null;
		PreparedStatement statement = null;
		try
		{
	...
	public void FindPrimaryKey(Object beanDataTmp) throws Exception
	{
		...
		B_QuotationData beanData = (B_QuotationData) beanDataTmp; 
			connection = getConnection();
			statement = connection.prepareStatement("SELECT  recordid  FROM B_Quotation WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			ResultSet resultSet = statement.executeQuery();
			if (!resultSet.next())
			{
		...
		{
			throw new Exception("Error executing SQL  SELECT  recordid  FROM B_Quotation WHERE  recordid =?");
		}
		finally
		{
			closeConnection(connection, statement);
