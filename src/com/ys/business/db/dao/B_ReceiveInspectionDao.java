...
public class B_ReceiveInspectionDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		{
			throw new Exception("INSERT INTO B_ReceiveInspection( recordid,ysid,contractid,arrivalid,materialid,quantity,report,memo,lossandcisposal,arrivedate,delaydays,inspecttime,waitdays,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_ReceiveInspection( recordid,ysid,contractid,arrivalid,materialid,quantity,report,memo,lossandcisposal,arrivedate,delaydays,inspecttime,waitdays,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,ysid,contractid,arrivalid,materialid,quantity,report,memo,lossandcisposal,arrivedate,delaydays,inspecttime,waitdays,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_ReceiveInspection WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,ysid,contractid,arrivalid,materialid,quantity,report,memo,lossandcisposal,arrivedate,delaydays,inspecttime,waitdays,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_ReceiveInspection"+str_Where);
			ResultSet resultSet = statement.executeQuery();
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_ReceiveInspection SET recordid= ? , ysid= ? , contractid= ? , arrivalid= ? , materialid= ? , quantity= ? , report= ? , memo= ? , lossandcisposal= ? , arrivedate= ? , delaydays= ? , inspecttime= ? , waitdays= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getYsid());			statement.setString( 3,beanData.getContractid());			statement.setString( 4,beanData.getArrivalid());			statement.setString( 5,beanData.getMaterialid());			statement.setString( 6,beanData.getQuantity());			statement.setString( 7,beanData.getReport());			statement.setString( 8,beanData.getMemo());			statement.setString( 9,beanData.getLossandcisposal());			if (beanData.getArrivedate()==null || beanData.getArrivedate().trim().equals(""))			{				statement.setNull( 10, Types.DATE);			}			else			{				statement.setString( 10, beanData.getArrivedate());			}			statement.setString( 11,beanData.getDelaydays());			statement.setString( 12,beanData.getInspecttime());			statement.setString( 13,beanData.getWaitdays());			statement.setString( 14,beanData.getDeptguid());			statement.setString( 15,beanData.getCreatetime());			statement.setString( 16,beanData.getCreateperson());			statement.setString( 17,beanData.getCreateunitid());			statement.setString( 18,beanData.getModifytime());			statement.setString( 19,beanData.getModifyperson());			statement.setString( 20,beanData.getDeleteflag());			statement.setString( 21,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_ReceiveInspection SET recordid= ? , ysid= ? , contractid= ? , arrivalid= ? , materialid= ? , quantity= ? , report= ? , memo= ? , lossandcisposal= ? , arrivedate= ? , delaydays= ? , inspecttime= ? , waitdays= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
