...
public class B_SupplierDao extends BaseAbstractDao
{
	...
	public String Create(Object beanDataTmp) throws Exception
	{
		...
		try
		{
			...
			statement = connection.prepareStatement("INSERT INTO B_Supplier( recordid,supplierid,shortname,suppliername,parentid,subid,categoryid,remarks,categorydes,paymentterm,country,province,city,address,zipcode,type,normaldelivery,maxdelivery,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getSupplierid());			statement.setString( 3,beanData.getShortname());			statement.setString( 4,beanData.getSuppliername());			statement.setString( 5,beanData.getParentid());			statement.setString( 6,beanData.getSubid());			statement.setString( 7,beanData.getCategoryid());			statement.setString( 8,beanData.getRemarks());			statement.setString( 9,beanData.getCategorydes());			statement.setString( 10,beanData.getPaymentterm());			statement.setString( 11,beanData.getCountry());			statement.setString( 12,beanData.getProvince());			statement.setString( 13,beanData.getCity());			statement.setString( 14,beanData.getAddress());			statement.setString( 15,beanData.getZipcode());			statement.setString( 16,beanData.getType());			statement.setString( 17,beanData.getNormaldelivery());			statement.setString( 18,beanData.getMaxdelivery());			statement.setString( 19,beanData.getDeptguid());			statement.setString( 20,beanData.getCreatetime());			statement.setString( 21,beanData.getCreateperson());			statement.setString( 22,beanData.getCreateunitid());			statement.setString( 23,beanData.getModifytime());			statement.setString( 24,beanData.getModifyperson());			statement.setString( 25,beanData.getDeleteflag());			statement.setString( 26,beanData.getFormid());
		...
		{
			throw new Exception("INSERT INTO B_Supplier( recordid,supplierid,shortname,suppliername,parentid,subid,categoryid,remarks,categorydes,paymentterm,country,province,city,address,zipcode,type,normaldelivery,maxdelivery,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)��"+ e.toString());
		}
		finally
		{
	...
	public String getInsertSQL()
	{
		...
		try
		{
			bufSQL.append("INSERT INTO B_Supplier( recordid,supplierid,shortname,suppliername,parentid,subid,categoryid,remarks,categorydes,paymentterm,country,province,city,address,zipcode,type,normaldelivery,maxdelivery,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid)VALUES(");
	...
	public Object FindByPrimaryKey(Object beanDataTmp)  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("SELECT recordid,supplierid,shortname,suppliername,parentid,subid,categoryid,remarks,categorydes,paymentterm,country,province,city,address,zipcode,type,normaldelivery,maxdelivery,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Supplier WHERE  recordid =?");
			statement.setString( 1,beanData.getRecordid());
			...
			returnData.setRecordid( resultSet.getString( 1));			returnData.setSupplierid( resultSet.getString( 2));			returnData.setShortname( resultSet.getString( 3));			returnData.setSuppliername( resultSet.getString( 4));			returnData.setParentid( resultSet.getString( 5));			returnData.setSubid( resultSet.getString( 6));			returnData.setCategoryid( resultSet.getString( 7));			returnData.setRemarks( resultSet.getString( 8));			returnData.setCategorydes( resultSet.getString( 9));			returnData.setPaymentterm( resultSet.getString( 10));			returnData.setCountry( resultSet.getString( 11));			returnData.setProvince( resultSet.getString( 12));			returnData.setCity( resultSet.getString( 13));			returnData.setAddress( resultSet.getString( 14));			returnData.setZipcode( resultSet.getString( 15));			returnData.setType( resultSet.getString( 16));			returnData.setNormaldelivery( resultSet.getString( 17));			returnData.setMaxdelivery( resultSet.getString( 18));			returnData.setDeptguid( resultSet.getString( 19));			returnData.setCreatetime( resultSet.getString( 20));			returnData.setCreateperson( resultSet.getString( 21));			returnData.setCreateunitid( resultSet.getString( 22));			returnData.setModifytime( resultSet.getString( 23));			returnData.setModifyperson( resultSet.getString( 24));			returnData.setDeleteflag( resultSet.getString( 25));			returnData.setFormid( resultSet.getString( 26));
			return returnData;
		}
		catch(Exception e)
		{
			throw new Exception("Error executing SQL SELECT recordid,supplierid,shortname,suppliername,parentid,subid,categoryid,remarks,categorydes,paymentterm,country,province,city,address,zipcode,type,normaldelivery,maxdelivery,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Supplier  WHERE  "+e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public java.util.Vector Find(String astr_Where)  throws Exception
	{
		...
		try
		{
			...
			if(!str_Where.equals(""))
				str_Where=" WHERE " + str_Where ; 
			statement = connection.prepareStatement("SELECT recordid,supplierid,shortname,suppliername,parentid,subid,categoryid,remarks,categorydes,paymentterm,country,province,city,address,zipcode,type,normaldelivery,maxdelivery,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Supplier"+str_Where);
			ResultSet resultSet = statement.executeQuery();
		...
		{
			throw new Exception("Error executing SQL SELECT recordid,supplierid,shortname,suppliername,parentid,subid,categoryid,remarks,categorydes,paymentterm,country,province,city,address,zipcode,type,normaldelivery,maxdelivery,deptguid,createtime,createperson,createunitid,modifytime,modifyperson,deleteflag,formid FROM B_Supplier" + astr_Where +e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
	...
	public void Store()  throws Exception
	{
		...
		{
			connection = getConnection();
			statement = connection.prepareStatement("UPDATE B_Supplier SET recordid= ? , supplierid= ? , shortname= ? , suppliername= ? , parentid= ? , subid= ? , categoryid= ? , remarks= ? , categorydes= ? , paymentterm= ? , country= ? , province= ? , city= ? , address= ? , zipcode= ? , type= ? , normaldelivery= ? , maxdelivery= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?");
			statement.setString( 1,beanData.getRecordid());			statement.setString( 2,beanData.getSupplierid());			statement.setString( 3,beanData.getShortname());			statement.setString( 4,beanData.getSuppliername());			statement.setString( 5,beanData.getParentid());			statement.setString( 6,beanData.getSubid());			statement.setString( 7,beanData.getCategoryid());			statement.setString( 8,beanData.getRemarks());			statement.setString( 9,beanData.getCategorydes());			statement.setString( 10,beanData.getPaymentterm());			statement.setString( 11,beanData.getCountry());			statement.setString( 12,beanData.getProvince());			statement.setString( 13,beanData.getCity());			statement.setString( 14,beanData.getAddress());			statement.setString( 15,beanData.getZipcode());			statement.setString( 16,beanData.getType());			statement.setString( 17,beanData.getNormaldelivery());			statement.setString( 18,beanData.getMaxdelivery());			statement.setString( 19,beanData.getDeptguid());			statement.setString( 20,beanData.getCreatetime());			statement.setString( 21,beanData.getCreateperson());			statement.setString( 22,beanData.getCreateunitid());			statement.setString( 23,beanData.getModifytime());			statement.setString( 24,beanData.getModifyperson());			statement.setString( 25,beanData.getDeleteflag());			statement.setString( 26,beanData.getFormid());
		...
		{
			throw new Exception("UPDATE B_Supplier SET recordid= ? , supplierid= ? , shortname= ? , suppliername= ? , parentid= ? , subid= ? , categoryid= ? , remarks= ? , categorydes= ? , paymentterm= ? , country= ? , province= ? , city= ? , address= ? , zipcode= ? , type= ? , normaldelivery= ? , maxdelivery= ? , deptguid= ? , createtime= ? , createperson= ? , createunitid= ? , modifytime= ? , modifyperson= ? , deleteflag= ? , formid=? WHERE  recordid  = ?"+ e.toString());
		}
		finally
		{
			closeConnection(connection, statement);
