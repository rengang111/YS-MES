...
public class BusinessDbUpdateEjb  {
    ...
    public String executeProcessControlAdd(String data, UserInfo userInfo) throws Exception {
    	B_ProjectTaskData dbData = new B_ProjectTaskData();
    	B_ProjectTaskDao dao = new B_ProjectTaskDao();
    	B_ProjectTaskCostData dbCostData = new B_ProjectTaskCostData();
    	B_ProjectTaskCostDao costDao = new B_ProjectTaskCostDao();
		...
		try {
			...
			//TODO
			executeUpdateProcessControl(guid, data, userInfo);
    ...
    public String executeProcessControlUpdate(String data, UserInfo userInfo) throws Exception {
		...
		try {
			...
			executeUpdateProcessControl(id, data, userInfo);
    ...
    private void executeUpdateProcessControl(String guid, String data, UserInfo userInfo) throws Exception {
    	BaseService service = new BaseService();
    	B_ProjectTaskCostData dbCostData = new B_ProjectTaskCostData();
    	B_ProjectTaskCostDao costDao = new B_ProjectTaskCostDao();
    ...
    public void executeUpdateProcessControlConfirm(String guid, String data, UserInfo userInfo) throws Exception {
    	BaseService service = new BaseService();
    	B_ProjectTaskCostData dbCostData = new B_ProjectTaskCostData();
    	B_ProjectTaskCostDao costDao = new B_ProjectTaskCostDao();
