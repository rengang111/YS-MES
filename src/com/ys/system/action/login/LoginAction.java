package com.ys.system.action.login;
...
import com.ys.system.service.login.LoginService;
...
public class LoginAction extends BaseAction {
     ...
     * 初始化验证图片属性       
     */        
    public void initVerifyCode() throws ServletException {         
        // 从web.xml中获取初始信息         
        // 宽度         
        String strWidth ="100";         
        // 高度         
    ...
    public String doLogin(@ModelAttribute("dataModels")LoginModel dataModel, BindingResult result, Model model, HttpSession session, HttpServletRequest request, HttpServletResponse response){
    	
        String validateCode = (String)session.getAttribute("validateCode");
        String returnUrl = "";

        dataModel = loginService.doLogin(request, dataModel, validateCode);
        
        if (dataModel.getMessage().equals("")) {
        	try {
	        	UserInfo userInfo = loginService.setUserInfo(request, dataModel.getData());
