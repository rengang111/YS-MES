...
public class Constants {
	...
	public static final String FORM_PRODUCEGROUPCODE = "producegroupcode";//生产组Code编码
	...
	public static final String FORM_MATERIALPARTSSTOCKOUT= "materialpartsstockout";//配件单出库
	...
	public static final String FORM_WAREHOUSECODE = "warehouseCode";//仓库编码
